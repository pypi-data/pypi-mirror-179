...
class Ticker:
    ...
    def _repairZeroPrices(self, df, interval):
        ...
        # Update: if prices=NaN but dividend or split exists, then implies trading did occur
        f_event = (df2["Dividends"]!=0)|(df2["Stock Splits"]!=0)
        f_nan = df2[data_cols].isna().any(axis=1)
        f_zeroes = f_zeroes | (f_nan & f_event)
