...
async def present(
    ...
    **Autogenerated function**
    ...
    response_get = await hub.exec.request.json.get(
        ctx,
        url=f"{hub.exec.azure.URL}/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Network/routeTables/{route_table_name}?api-version=2021-03-01",
        success_codes=[200],
    )
