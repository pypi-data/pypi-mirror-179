...
# %% auto 0
__all__ = ['cd_root', 'nbdev_setup', 'TestRunner', 'md', 'replace_imports', 'get_test_and_library_folders', 'get_nbs_folder',
           'nbdev_build_test', 'ds_build_all', 'nbdev_update_all', 'nbdev_sync']
...
# %% ../../nbs/utils/nbdev_utils.ipynb 34
...
def _move_folders_before (library_name=None, test_folder='tests'):
    library_name, test_folder = get_test_and_library_folders (library_name=library_name,
                                                              test_folder=test_folder)
    nbs_folder = get_nbs_folder ()
    if os.path.exists ('00_tests'):
        print (f'moving notebooks in 00_tests to {nbs_folder}')
        shutil.move ('00_tests', nbs_folder)
        
    if os.path.exists (f'{library_name}/__init__.py'):
        shutil.move (f'{library_name}/__init__.py', f'{library_name}/init.py')
        
def _move_folders_after (library_name=None, test_folder='tests'):
    library_name, test_folder = get_test_and_library_folders (library_name=library_name,
                                                              test_folder=test_folder)
    nbs_folder = get_nbs_folder ()
    shutil.move (f'{nbs_folder}/00_tests', '.')
    if os.path.exists (f'{library_name}/init.py'):
        shutil.move (f'{library_name}/init.py', f'{library_name}/__init__.py')

# %% ../../nbs/utils/nbdev_utils.ipynb 40
def ds_build_all ():
    from nbdev.doclinks import nbdev_export

    _move_folders_before ()
    build_test_nb ()
    nbdev_export ()
    nbdev_build_test ()
    _move_folders_after ()
...
# %% ../../nbs/utils/nbdev_utils.ipynb 47
def nbdev_sync ():
