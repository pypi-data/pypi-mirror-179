...
from cooptools.geometry.circles.utils import random_point_in_circle, random_point_on_circle
...
def point_on_circle(center: Tuple[float, float], radius: float) -> Tuple[float, float]:
    return random_point_on_circle(center=center, radius=radius)

def point_in_circle(center: Tuple[float, float], radius: float) -> Tuple[float, float]:
    return random_point_in_circle(center=center, radius=radius)
