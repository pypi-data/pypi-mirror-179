...
def siga_obj(base: 'DataFrame', objeto: str):
    ...
    objeto: nombre del objeto de búsqueda, debe estar en mayúscula

    El output se debe almacenar en un DataFrame
...
def precio_obj(siga_objeto: 'DataFrame'):

    '''
    Proporciona una base de precios de un objeto de la base SIGA

    siga_objeto: output de la función siga_obj
...
def siga_cod(base: 'DataFrame',codigo: str):
...
def precio_cod(siga_codigo):

    '''
    Proporciona una base de precios de un código de la base SIGA

    siga_codigo: output de la función siga_cod
