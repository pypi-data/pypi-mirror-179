...
from media_platform.service.file_service.change_file_storage_class_request import ChangeFileStorageClassRequest
...
class FileService(MediaPlatformService):
    ...
    def change_file_storage_class_request(self) -> ChangeFileStorageClassRequest:
        return ChangeFileStorageClassRequest(self._authenticated_http_client, self._base_url)
