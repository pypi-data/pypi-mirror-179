...
from media_platform.service.flow_control_service.specifications.change_file_storage_class_specification import \
    ChangeFileStorageClassSpecification
...
class ComponentType:
    ...
    copy_file = 'file.copy'
    change_file_storage_class = 'file.change_storage_class'
...
_SPECIFICATIONS = {
    ...
    ComponentType.change_file_storage_class: ChangeFileStorageClassSpecification,
