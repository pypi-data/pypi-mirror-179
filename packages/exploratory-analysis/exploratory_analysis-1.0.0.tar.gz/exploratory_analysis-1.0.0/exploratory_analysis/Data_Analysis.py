def EDA(df):
    ...
    print('#'*100)
    print('Folders are created for the graphs by datatypes')
    print('#'*100)
...
# Generates descriptive stats
    ...
    print('#'*100)
    print('Combined PDF Complete for all data type variables, '+project_name+' executed suceessfully')
    print('Check the output in the following directory '+directory_path_of_data, '!!')
    print('#'*100) 
