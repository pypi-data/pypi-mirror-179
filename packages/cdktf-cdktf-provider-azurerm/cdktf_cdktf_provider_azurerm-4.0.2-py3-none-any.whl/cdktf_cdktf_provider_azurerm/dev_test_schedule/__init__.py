...
class DevTestScheduleDailyRecurrence:
    def __init__(self, *, time: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, time: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class DevTestScheduleDailyRecurrenceOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DevTestScheduleDailyRecurrence]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DevTestScheduleHourlyRecurrence:
    def __init__(self, *, minute: jsii.Number) -> None:
        ...
        '''
        if __debug__:
            def stub(*, minute: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class DevTestScheduleHourlyRecurrenceOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DevTestScheduleHourlyRecurrence]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class DevTestScheduleWeeklyRecurrenceOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DevTestScheduleWeeklyRecurrence]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
