...
from sharingiscaring.pool import ConcordiumPool, ConcordiumPoolFromNode
...
def test_pool_1(node: ConcordiumClient):
    pool = ConcordiumPoolFromNode(**read_pool_information(72723))
...
def test_poolstatus_0(node: ConcordiumClient):
    getPoolStatus = ConcordiumPoolFromNode(**node.request_pool_status('72724'))
    assert getPoolStatus == None

def test_poolstatus_1(node: ConcordiumClient):
    getPoolStatus = ConcordiumPoolFromNode(**node.request_pool_status('72723'))
