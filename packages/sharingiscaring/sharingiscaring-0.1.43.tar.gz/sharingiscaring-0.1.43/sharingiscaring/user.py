...
class User:
    ...
    def prepare_for_subscription_logic(self,
        ...
        self.get_explorer_transactions(ccdscan)
        self.get_explorer_delegators(ccdscan)
        self.set_count_messages(mongodb, ENVIRONMENT)

    def get_explorer_transactions(self, ccdscan: CCDScan):
        try:
            explorer_ccd_transactions, _ = ccdscan.ql_get_all_transactions_for_explorer_ccd(None, SubscriptionDetails.EXPLORER_CCD.value)
            self.explorer_ccd_transactions = [x['node']['transaction'] for x in explorer_ccd_transactions]
        except:
            self.explorer_ccd_transactions = []
    ...
    def perform_subscription_logic(self, 
        ...
        for tx in self.explorer_ccd_transactions:
