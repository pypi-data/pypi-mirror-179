...
- targetClassName (string; required)"""
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, targetClassName=Component.REQUIRED, **kwargs):
        self._prop_names = ['children', 'id', 'targetClassName']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'targetClassName']
