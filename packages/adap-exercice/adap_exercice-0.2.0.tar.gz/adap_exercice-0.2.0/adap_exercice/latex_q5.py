...
from .resolution import form_A, opt_A, resol_prof_HH
...
def question_5(
    ...
    """It takes the parameters of the model and returns the LaTeX code for the fifth question.
    ...
    Returns
    -------
        The latex code of the fifth question of the report.
