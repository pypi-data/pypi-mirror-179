...
class ResNet20(ResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `ResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 3, 3, 3], [16, 16, 32, 64])), BasicBlock, small_images=True, **kwargs)
...
class ResNet32(ResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `ResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 5, 5, 5], [16, 16, 32, 64])), BasicBlock, small_images=True, **kwargs)
...
class ResNet44(ResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `ResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 7, 7, 7], [16, 16, 32, 64])), BasicBlock, small_images=True, **kwargs)
...
class ResNet56(ResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `ResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 9, 9, 9], [16, 16, 32, 64])), BasicBlock, small_images=True, **kwargs)
...
class ResNet110(ResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `ResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 18, 18, 18], [16, 16, 32, 64])), BasicBlock, small_images=True, **kwargs)
...
class ResNet164(ResNet):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(list(zip([1, 18, 18, 18], [16, 16, 32, 64])), Bottleneck, small_images=True, **kwargs)
...
class ResNet1001(ResNet):
    ...
    def __init__(self, **kwargs):
        ...
        """
        # Following [2] -> Usage of bottle neck
        super().__init__(list(zip([1, 111, 111, 111], [16, 16, 32, 64])), Bottleneck, small_images=True, **kwargs)
...
class ResNet1202(ResNet):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(list(zip([1, 200, 200, 200], [16, 16, 32, 64])), BasicBlock, small_images=True, **kwargs)
...
class WideResNet16(ResNet):
    ...
    def __init__(self, width=1, drop_rate=0.3, **kwargs):
        """Constructor

        Args:
            width (int): width of the resnet
                Default: 1 (No width <=> ResNet14)
