...
class PreActResNet20(PreActResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `PreActResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 3, 3, 3], [16, 16, 32, 64])), PreActBlock, small_images=True, **kwargs)
...
class PreActResNet32(PreActResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `PreActResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 5, 5, 5], [16, 16, 32, 64])), PreActBlock, small_images=True, **kwargs)
...
class PreActResNet44(PreActResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `PreActResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 7, 7, 7], [16, 16, 32, 64])), PreActBlock, small_images=True, **kwargs)
...
class PreActResNet56(PreActResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `PreActResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 9, 9, 9], [16, 16, 32, 64])), PreActBlock, small_images=True, **kwargs)
...
class PreActResNet110(PreActResNet):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            kwargs: Any valid argument for `PreActResNet` class (See the documentation)
        """
        super().__init__(list(zip([1, 18, 18, 18], [16, 16, 32, 64])), PreActBlock, small_images=True, **kwargs)
...
class PreActResNet164(PreActResNet):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(list(zip([1, 18, 18, 18], [16, 16, 32, 64])), PreActBottleneck, small_images=True, **kwargs)
...
class PreActResNet1001(PreActResNet):
    ...
    def __init__(self, **kwargs):
        ...
        """
        # Following [2] -> Usage of bottle neck
        super().__init__(list(zip([1, 111, 111, 111], [16, 16, 32, 64])), PreActBottleneck, small_images=True, **kwargs)
...
class PreActResNet1202(PreActResNet):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(list(zip([1, 200, 200, 200], [16, 16, 32, 64])), PreActBlock, small_images=True, **kwargs)
