...
class AwsProvider(
    ...
    def assume_role(self, value: typing.Optional["AwsProviderAssumeRole"]) -> None:
        if __debug__:
            def stub(value: typing.Optional[AwsProviderAssumeRole]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def default_tags(self, value: typing.Optional["AwsProviderDefaultTags"]) -> None:
        if __debug__:
            def stub(value: typing.Optional[AwsProviderDefaultTags]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def ignore_tags(self, value: typing.Optional["AwsProviderIgnoreTags"]) -> None:
        if __debug__:
            def stub(value: typing.Optional[AwsProviderIgnoreTags]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
