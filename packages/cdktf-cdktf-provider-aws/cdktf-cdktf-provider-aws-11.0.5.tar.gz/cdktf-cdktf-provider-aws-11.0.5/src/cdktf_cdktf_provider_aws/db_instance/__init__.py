...
class DbInstance(
    ...
    def __init__(
        ...
        *,
        ...
        blue_green_update: typing.Optional[typing.Union["DbInstanceBlueGreenUpdate", typing.Dict[str, typing.Any]]] = None,
...
class DbInstanceBlueGreenUpdateOutputReference(
    ...
    def internal_value(self, value: typing.Optional[DbInstanceBlueGreenUpdate]) -> None:
        if __debug__:
            def stub(value: typing.Optional[DbInstanceBlueGreenUpdate]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
