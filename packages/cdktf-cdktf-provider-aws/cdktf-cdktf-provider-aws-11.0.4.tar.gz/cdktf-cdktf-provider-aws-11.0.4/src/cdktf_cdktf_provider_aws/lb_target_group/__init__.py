...
class LbTargetGroup(
    ...
    def __init__(
        ...
        *,
        ...
        target_failover: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["LbTargetGroupTargetFailover", typing.Dict[str, typing.Any]]]]] = None,
    ...
    def put_target_failover(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["LbTargetGroupTargetFailover", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def target_failover_input(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["LbTargetGroupTargetFailover"]]]:
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["LbTargetGroupTargetFailover"]]], jsii.get(self, "targetFailoverInput"))
...
class LbTargetGroupConfig(cdktf.TerraformMetaArguments):
    ...
    def target_failover(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["LbTargetGroupTargetFailover"]]], result)
...
class LbTargetGroupHealthCheckOutputReference(
    ...
    def internal_value(self, value: typing.Optional[LbTargetGroupHealthCheck]) -> None:
        if __debug__:
            def stub(value: typing.Optional[LbTargetGroupHealthCheck]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class LbTargetGroupStickinessOutputReference(
    ...
    def internal_value(self, value: typing.Optional[LbTargetGroupStickiness]) -> None:
        if __debug__:
            def stub(value: typing.Optional[LbTargetGroupStickiness]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class LbTargetGroupTargetFailoverList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[LbTargetGroupTargetFailover]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[LbTargetGroupTargetFailover]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[LbTargetGroupTargetFailover]]],
...
class LbTargetGroupTargetFailoverOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[LbTargetGroupTargetFailover, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[LbTargetGroupTargetFailover, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[LbTargetGroupTargetFailover, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[LbTargetGroupTargetFailover, cdktf.IResolvable]],
