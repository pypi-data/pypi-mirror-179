...
class IvschatLoggingConfiguration(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        destination_configuration: typing.Optional[typing.Union["IvschatLoggingConfigurationDestinationConfiguration", typing.Dict[str, typing.Any]]] = None,
        id: typing.Optional[builtins.str] = None,
        name: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        tags_all: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        timeouts: typing.Optional[typing.Union["IvschatLoggingConfigurationTimeouts", typing.Dict[str, typing.Any]]] = None,
    ...
    def put_destination_configuration(
        self,
        *,
        cloudwatch_logs: typing.Optional[typing.Union["IvschatLoggingConfigurationDestinationConfigurationCloudwatchLogs", typing.Dict[str, typing.Any]]] = None,
        firehose: typing.Optional[typing.Union["IvschatLoggingConfigurationDestinationConfigurationFirehose", typing.Dict[str, typing.Any]]] = None,
        s3: typing.Optional[typing.Union["IvschatLoggingConfigurationDestinationConfigurationS3", typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["IvschatLoggingConfigurationTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["IvschatLoggingConfigurationTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class IvschatLoggingConfigurationConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class IvschatLoggingConfigurationDestinationConfigurationFirehose:
    def __init__(self, *, delivery_stream_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, delivery_stream_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class IvschatLoggingConfigurationTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[IvschatLoggingConfigurationTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[IvschatLoggingConfigurationTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[IvschatLoggingConfigurationTimeouts, cdktf.IResolvable]],
