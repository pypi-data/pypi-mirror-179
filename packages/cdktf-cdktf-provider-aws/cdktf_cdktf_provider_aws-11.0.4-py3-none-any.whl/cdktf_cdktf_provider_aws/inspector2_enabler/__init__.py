...
class Inspector2Enabler(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["Inspector2EnablerTimeouts", typing.Dict[str, typing.Any]]] = None,
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["Inspector2EnablerTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["Inspector2EnablerTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class Inspector2EnablerConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class Inspector2EnablerTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[Inspector2EnablerTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[Inspector2EnablerTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[Inspector2EnablerTimeouts, cdktf.IResolvable]],
