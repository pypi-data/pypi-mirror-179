...
[![Supported py versions](https://img.shields.io/pypi/pyversions/klldpy.svg)](https://pypi.org/project/klldpy/)
[![Current pypi version](https://img.shields.io/pypi/v/klldpy.svg)](https://pypi.org/project/klldpy/)
...
# Documentation
https://klldpy.42web.io/en/latest/

# Installing
```
# windows
py -3 -m pip install -U klldpy

# linux
python3 -m pip install -U klldpy
```
...
from klldpy.ext import commands
