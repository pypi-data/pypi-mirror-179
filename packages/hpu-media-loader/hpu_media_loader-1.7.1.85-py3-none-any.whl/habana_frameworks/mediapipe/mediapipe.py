...
class MediaPipe(ABC):
    ...
    """
    @abstractmethod
    def __init__(self, device=None, prefetch_depth=2, batch_size=1, pipename=None):
        """
        Constructor method.
        ...
        self._device_type_, self._device_id_ = getDeviceIdFromDeviceName(
            device)
        print("MediaPipe device {} device_type {} device_id {} pipename {}".format(
            device, self._device_type_, self._device_id_, pipename))
