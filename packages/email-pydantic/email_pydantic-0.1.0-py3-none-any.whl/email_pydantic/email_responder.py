...
class EmailResponder:
    ...
    Attributes:
        ...
        server (SMTP_SSL): The SMTP __server to use. Defaults to None.
    ...
    def login(self, host="smtp.gmail.com", port=465):
        """Logs in the EmailResponder to the SMTP __server.
    ...
    def logout(self):
        """Logs out the EmailResponder from the SMTP __server.
