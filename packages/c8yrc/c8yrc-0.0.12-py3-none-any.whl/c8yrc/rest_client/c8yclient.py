...
class CumulocityClient:
    ...
    def _progress_bar(monitor):
        ...
        CumulocityClient.current_bytes = CumulocityClient.current_bytes + monitor.bytes_read
        if CumulocityClient.current_bytes < CumulocityClient.delta_bytes and \
                CumulocityClient.current_bytes < monitor.len:
            return
