...
import { getTransformerEnabled, setTransformerEnabled, getTransformerProxyUrl, addStatusChangeListener, StatusContent, triggerStatusUpdate } from './../settings';
                        ...
                        <div className={ 'transformer-component' + (this.state.isEnabled ? '' : ' hidden') } style={{ marginTop: '1em' }}>
                            ...
                            <Accordion style={{ margin: '0 0.2em' }}>
                                ...
                                >
                                    ...
                                    >Transformer NB: {this.state.transformerNotebookPath? 'Existed': 'Not Found!'}</Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography variant="body2" gutterBottom>
                                        {this.state.transformerNotebookPath? 'The notebook ' + this.state.transformerNotebookPath + ' will be converted to transformer.py and apply to proxy.': 'Notebook transformer.ipynb is not found!'}
                                    </Typography>
                                </AccordionDetails>
                            </Accordion>
                        </div>
