    ...
    def calculate_graph(self, item):
        ...
        while len(items_to_produce) > 0:
            ...
            if recipe is not None:
                ...
                amount_multiplier = item_to_produce.amount * recipe.production_time / recipe_output.amount
        ...
        for production_item_name, production_item in production_items.items():
            ...
            if recipe is not None:
                ...
                production_item.num_machines = recipe.production_time * production_item.amount / recipe_output.amount
        ...
        for production_item_name, production_item in production_items.items():
            ...
            if recipe is not None:
                ...
                for recipe_input in recipe.inputs:
                    ...
                    #production_weight = production_item.amount / recipe_output.amount * recipe.production_time
                    production_weight = recipe_input.amount * production_item.amount * recipe.production_time / recipe_output.amount
