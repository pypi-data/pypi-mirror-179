...
class Ui_ViewGraphicsDialog(object):
    def setupUi(self, ViewGraphicsDialog):
        ...
        self.checkBoxCounter1 = QtWidgets.QCheckBox(ViewGraphicsDialog)
        self.checkBoxCounter1.setObjectName("checkBoxCounter1")
        self.verticalLayout.addWidget(self.checkBoxCounter1)

        self.checkBoxCounter2 = QtWidgets.QCheckBox(ViewGraphicsDialog)
        self.checkBoxCounter2.setObjectName("checkBoxCounter2")
        self.verticalLayout.addWidget(self.checkBoxCounter2)
    ...
    def retranslateUi(self, ViewGraphicsDialog):
        ...
        self.checkBoxCounter1.setText(_translate("ViewGraphicsDialog", "COUNTER 1"))
        self.checkBoxCounter2.setText(_translate("ViewGraphicsDialog", "COUNTER 2"))
...
class ViewGraphicsDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent, checkBoxMCPX1Checked, checkBoxMCPX2Checked, checkBoxMCPY1Checked, checkBoxMCPY2Checked,checkBoxDataDescriptionChecked,checkBoxCounter1,checkBoxCounter2):
        ...
        self.ui.checkBoxCounter1.setChecked(checkBoxCounter1)
        self.ui.checkBoxCounter2.setChecked(checkBoxCounter2)
