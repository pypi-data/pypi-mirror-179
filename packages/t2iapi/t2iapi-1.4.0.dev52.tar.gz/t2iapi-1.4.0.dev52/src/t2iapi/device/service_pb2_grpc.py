...
class DeviceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateElementsInStates = channel.unary_unary(
                '/t2iapi.device.DeviceService/GenerateElementsInStates',
                request_serializer=t2iapi_dot_device_dot_device__requests__pb2.GenerateElementsInStatesRequest.SerializeToString,
                response_deserializer=t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
                )
...
class DeviceServiceServicer(object):
    ...
    def GenerateElementsInStates(self, request, context):
        """
        Generate all elements, that can possibly exist at the same time and fulfill the given path.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DeviceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GenerateElementsInStates': grpc.unary_unary_rpc_method_handler(
                    servicer.GenerateElementsInStates,
                    request_deserializer=t2iapi_dot_device_dot_device__requests__pb2.GenerateElementsInStatesRequest.FromString,
                    response_serializer=t2iapi_dot_basic__responses__pb2.BasicResponse.SerializeToString,
            ),
...
class DeviceService(object):
    ...
    @staticmethod
    def GenerateElementsInStates(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/t2iapi.device.DeviceService/GenerateElementsInStates',
            t2iapi_dot_device_dot_device__requests__pb2.GenerateElementsInStatesRequest.SerializeToString,
            t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
