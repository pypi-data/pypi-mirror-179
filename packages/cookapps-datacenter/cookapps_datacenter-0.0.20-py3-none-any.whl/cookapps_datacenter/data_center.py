...
class DataCenter:
    ...
    def __init__(
        ...
        if glue_config is not None:
            self.glue = self.Glue(
                glue_config=glue_config, glue_client=self.client("glue", region_name=glue_config.region)
            )
    ...
    class Glue:
        ...
        def start_workflow_run(self, name: str, params: dict = None) -> dict:
            ...
            if params is not None:
                ...
                response = self.glue_client.put_workflow_run_properties(Name=name, RunId=run_id, RunProperties=params)
            return response
