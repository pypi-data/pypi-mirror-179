...
torch_credentials = {
    'url': os.getenv('TORCH_CATALOG_URL', 'https://torchtenant.unified.acceldata.tech'),
    'access_key': os.getenv('TORCH_ACCESS_KEY', 'RK0CSWTO6440ZLM'),
    'secret_key': os.getenv('TORCH_SECRET_KEY', 'E4ZLXUIQ3SPOA78SN1VA8OHJGGWZHS')
}