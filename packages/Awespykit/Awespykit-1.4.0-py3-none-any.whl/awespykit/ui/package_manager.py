...
class Ui_package_manager(object):
    def setupUi(self, package_manager):
        ...
        self.lw_env_list.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        ...
        self.tw_installed_info.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
    ...
    def retranslateUi(self, package_manager):
        ...
        self.btn_delselected.setToolTip(_translate("package_manager", "将 Python 环境列表中的选中项移除(不会删除本机 Python 目录)。"))
        self.btn_delselected.setText(_translate("package_manager", "移除选中项"))
