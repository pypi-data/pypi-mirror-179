...
class GtkStatusIcon:
    ...
    def daemon_start(self, widget):
        ...
        if daemon_status() == 'SUN not running':
            subprocess.call(f'{bin_path}sun start', shell=True)
            data = 'Daemon Starts'
        else:
            data = 'Daemon is already running...'
    ...
    def daemon_stop(self, widget):
        ...
        title = 'Daemon'
        subprocess.call(f'{bin_path}sun stop', shell=True)
        data = 'Daemon stops'
        self.message(data, title)
    ...
    def daemon_restart(self, widget):
        ...
        title = 'Daemon'
        subprocess.call(f'{bin_path}sun restart', shell=True)
