...
urlpatterns = [
    ...
    url(r'^users/(?P<pk>[0-9]+)/yarn', AnnotationViewset.urls(model_prefix="yarn", model=Annotation)),
    url(r'^users/(?P<pk>[0-9]+)/tags', TagViewset.urls(model_prefix="tags", model=Tag)),
]
