...
class DataCloudflareApiTokenPermissionGroups(
    ...
    def account(self) -> cdktf.StringMap:
        return typing.cast(cdktf.StringMap, jsii.get(self, "account"))
    ...
    def zone(self) -> cdktf.StringMap:
        return typing.cast(cdktf.StringMap, jsii.get(self, "zone"))
