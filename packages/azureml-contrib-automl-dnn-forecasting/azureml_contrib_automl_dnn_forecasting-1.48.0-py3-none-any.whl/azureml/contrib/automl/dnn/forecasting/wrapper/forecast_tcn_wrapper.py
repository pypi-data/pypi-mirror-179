...
from .tcn_model_utl import build_canned_model, is_embedding_needed
...
class ForecastTCNWrapper(DNNForecastWrapper):
    ...
    def train(self, n_epochs: int, X: DataInputType = None, y: DataInputType = None,
        ...
        ds = create_timeseries_datasets(X_train,
                                        ...
                                        embedding_enabled=is_embedding_needed(self.params),
                                        **settings)
        ...
        if self.forecaster is None:
            ...
            self._build_model_forecaster(run_update_callback, dset_config, ds)
