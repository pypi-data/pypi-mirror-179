...
class FeaturesEnricher(TransformerMixin):
    ...
    def __show_selected_features(self, search_keys: Dict[str, SearchKey]):
        ...
        try:
            ...
            print(Format.GREEN + Format.BOLD + msg + Format.END)
            styled_features_info = self.features_info.head(60).style
            if hasattr(styled_features_info, "hide"):
                display(styled_features_info.hide(axis="index"))
            elif hasattr(styled_features_info, "hide_index"):
                display(styled_features_info.hide_index())
            else:
                display(styled_features_info)
