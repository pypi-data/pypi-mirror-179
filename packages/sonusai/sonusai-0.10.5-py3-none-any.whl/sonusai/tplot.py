...
def tplot(root: str = None,
    ...
    for m in range(num_mixtures):
        ...
        # Trim waveform data
        mixture_trimmed = int16_to_float(audio_data.mixture[mixture_begin:mixture_end])
        target_trimmed = int16_to_float(sum(audio_data.targets)[mixture_begin:mixture_end])
