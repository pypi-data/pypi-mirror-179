...
class PosOptYmerger(OptYmerger):
    """
    ...
    def __init__(self, name, inports: List[Tuple[float, float, float, float]], shift: float,
                 *, layer=10, etchlayer = 15, keepFirst = False):
        super().__init__(name, inports, shift, layer=layer)
        self.etchlayer = etchlayer
        self.flagKeep = keepFirst
        self.createEtchMask()
