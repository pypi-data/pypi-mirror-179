...
class Test( MMTTest ):
	...
	def test_pull_specific_files( self ):
		...
		data = self.pull( c = 1, filepaths = filepaths )
...
class Regressions( MMTTest ):
	...
	def test_regression_MMT_59( self ):
		def pull_and_verify_single_file_updated( filepath: str ):
			data = self.pull( c = 1, filepaths = [ filepath ] )
		...
		pull_and_verify_single_file_updated( self.template_path( 'regression_mmt-59.mvt' ) )
		pull_and_verify_single_file_updated( self.property_path( 'readytheme_contentsection', 'regression_MMT-59.mvt' ) )
		pull_and_verify_single_file_updated( self.property_product_path( 'header', 'regression_MMT-59.mvt' ) )
		pull_and_verify_single_file_updated( self.property_category_path( 'header', 'regression_MMT-59.mvt' ) )
		pull_and_verify_single_file_updated( self.cssresource_path( 'regression_MMT-59.json' ) )
		pull_and_verify_single_file_updated( self.jsresource_path( 'regression_MMT-59.json' ) )
		pull_and_verify_single_file_updated( self.resourcegroup_path( 'regression_MMT-59.json' ) )
