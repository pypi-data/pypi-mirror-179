...
class dataAccess:
    ...
    def getLast(self, device_id, sensors=None, n = 1, cal = None):
    ...
    def dataQuery(self, device_id, start_time, end_time = time.time(), sensors = None , cal = None, echo = "true"):
      ...
      while True:
        ...
        if cursor['start'] == None or cursor['end'] == None:
          ...
          if echo == "true" or echo == "TRUE":
            sys.stdout.write('\r')
            sys.stdout.write(str(frameCount)+" records fetched..")
