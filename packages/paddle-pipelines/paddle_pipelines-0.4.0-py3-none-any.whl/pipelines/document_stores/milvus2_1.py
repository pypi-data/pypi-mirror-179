...
class Milvus2DocumentStore(KeywordDocumentStore):
    """
    Limitations:
    ...
    For Pipelines users this means you can now run a query using vector similarity and filter for some meta data at the same time!
