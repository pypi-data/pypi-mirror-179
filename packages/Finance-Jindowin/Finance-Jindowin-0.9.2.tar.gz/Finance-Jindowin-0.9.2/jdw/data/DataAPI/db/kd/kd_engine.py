...
class FetchKDEngine(FetchEngine):
    ...
    def __init__(self):
        ...
        futures_tables = [
            ...
            'fut_factor_alpha191', 'fut_factor_basis', 'fut_factor_maturity',
            'fut_factor_momentum', 'fut_factor_overlap',
            'fut_factor_positions', 'fut_factor_statistics',
            'fut_factor_trend', 'fut_factor_volatility', 'fut_factor_volume'
        ]
