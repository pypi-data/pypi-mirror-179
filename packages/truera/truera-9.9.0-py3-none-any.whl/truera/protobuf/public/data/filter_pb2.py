...
_FILTEREXPRESSIONOPERATOR = DESCRIPTOR.enum_types_by_name['FilterExpressionOperator']
FilterExpressionOperator = enum_type_wrapper.EnumTypeWrapper(_FILTEREXPRESSIONOPERATOR)
UNKNOWN = 0
FEO_AND = 1
FEO_OR = 2
FEO_NOT = 3
...
_FILTERLEAF = DESCRIPTOR.message_types_by_name['FilterLeaf']
_FILTERLEAF_FILTERLEAFVALUETYPE = _FILTERLEAF.enum_types_by_name['FilterLeafValueType']
_FILTERLEAF_FILTERLEAFCOMPARISONTYPE = _FILTERLEAF.enum_types_by_name['FilterLeafComparisonType']
FilterExpression = _reflection.GeneratedProtocolMessageType('FilterExpression', (_message.Message,), {
  'DESCRIPTOR' : _FILTEREXPRESSION,
  '__module__' : 'truera.protobuf.public.data.filter_pb2'
  # @@protoc_insertion_point(class_scope:truera.data.FilterExpression)
  })
_sym_db.RegisterMessage(FilterExpression)

FilterLeaf = _reflection.GeneratedProtocolMessageType('FilterLeaf', (_message.Message,), {
  'DESCRIPTOR' : _FILTERLEAF,
  '__module__' : 'truera.protobuf.public.data.filter_pb2'
  # @@protoc_insertion_point(class_scope:truera.data.FilterLeaf)
  })
_sym_db.RegisterMessage(FilterLeaf)
