...
class GitLab:
    ...
    def __globals(self, data: ParsersData, global_values, stages) -> None:
    ...
    # Globals image
    @staticmethod
    def __globals_image(image_data: Union[Dict[str, Any], str], global_values) -> None:
    ...
    # Globals services
    @staticmethod
    def __globals_services(services_data, global_values) -> None:
    ...
    # Globals variables
    def __globals_variables(self, variables_data) -> None:
            ...
            for matrix_item in data[node]['parallel']['matrix']:
                ...
                for matrix_variable, matrix_values in matrix_item.items():
                    ...
                    if matrix_variable in environ:
                        matrix_item_variables[matrix_variable] = [
                    ...
                    # Matrix defined environment variable
                        ...
                        for matrix_value in matrix_values:
                            matrix_item_variables[matrix_variable] += [matrix_value]

                # Register all item combinations
                keys, values = zip(*matrix_item_variables.items())
    ...
    def job(self, job_node: str, job_name: str, data: ParsersData, global_values,
            extend: bool = False) -> Dict[str, Any]:
