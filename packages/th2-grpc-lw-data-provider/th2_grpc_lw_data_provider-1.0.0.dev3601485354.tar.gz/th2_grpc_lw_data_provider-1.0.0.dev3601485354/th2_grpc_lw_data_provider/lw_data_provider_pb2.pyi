...
class EventSearchRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["end_timestamp",b"end_timestamp","parent_event",b"parent_event","result_count_limit",b"result_count_limit","start_timestamp",b"start_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["end_timestamp",b"end_timestamp","filter",b"filter","parent_event",b"parent_event","result_count_limit",b"result_count_limit","search_direction",b"search_direction","start_timestamp",b"start_timestamp"]) -> None: ...
