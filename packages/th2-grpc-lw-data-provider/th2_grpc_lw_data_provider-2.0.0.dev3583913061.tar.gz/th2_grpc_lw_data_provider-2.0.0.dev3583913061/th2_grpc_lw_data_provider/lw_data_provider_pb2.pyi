...
class EventSearchRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["book_id",b"book_id","end_timestamp",b"end_timestamp","keep_open",b"keep_open","parent_event",b"parent_event","result_count_limit",b"result_count_limit","scope",b"scope","start_timestamp",b"start_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["book_id",b"book_id","end_timestamp",b"end_timestamp","filter",b"filter","keep_open",b"keep_open","parent_event",b"parent_event","result_count_limit",b"result_count_limit","scope",b"scope","search_direction",b"search_direction","start_timestamp",b"start_timestamp"]) -> None: ...
