...
class TestComputeEpicsRecords(unittest.TestCase):
    ...
    def setUp(self):
        self.frequencies = np.array(
            [17.1, 15.6, 16.4, 17.6, 410.3, 1083.7, 500.1, 500.1])
        self.known_epics = {
            ...
            'CAL-CS_TDEP_PCAL_X_COMPARE_CORRECTION':
            -3.978067573573798e-06-2.6500091829175134e-07j,
            'CAL-CS_TDEP_PCAL_Y_COMPARE_CORRECTION':
            3.978067573573798e-06+2.6500091829175134e-07j,
...
'''
        ...
        test_epics = darm.compute_epics_records(
            ...
            self.frequencies[6], self.frequencies[7], endstation=True)
