...
setup(
    name='https-rot',
    py_modules=['https-rot'],
    version='1.0.1',
    license="Apache 2.0",
    description='https-rot lets you access Django shell from your Python modules',
    author='Biwin John',
    author_email='biwinjohn@gmail.com',
    url='https://github.com/biwin/https-rot',
    download_url='https://github.com/biwin/https-rot/',
    install_requires=['django'],
    keywords=['django', 'https-rot', 'python'],
    classifiers=[
        'Framework :: Django',
