...
class SyntheticsPrivateLocation(
    ...
    def __init__(
        ...
        *,
        ...
        verified_script_execution: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
    ...
    def verified_script_execution_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "verifiedScriptExecutionInput"))
    ...
    def verified_script_execution(
        ...
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "verifiedScriptExecution"))
