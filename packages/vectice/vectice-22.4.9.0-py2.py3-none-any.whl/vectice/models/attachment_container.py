...
class AttachmentContainer:
    ...
    def update_attachments(self, file_path: Union[str, List[str]]):
        ...
        for file in file_path:
            try:
                ...
                _logger.warning(f"Could not read file '{file}'.")
    ...
    def delete_attachments(self, file_path: Union[List[str], str]):
        ...
        :param file_path: the path to the attachment
        """
        attachments = [file_path] if isinstance(file_path, str) else file_path
        ...
        for file in attachments:
            ...
            if file_id:
                ...
                raise ValueError(FILE_PATH_DOES_NOT_EXIST_ERROR_MESSAGE % file)
