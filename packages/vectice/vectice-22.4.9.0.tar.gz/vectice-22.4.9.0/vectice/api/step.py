...
class StepApi(GqlApi):
    def list_steps(self, phase_id: int) -> List[StepOutput]:
        ...
        try:
            ...
            raise self._error_handler.handle_post_gql_error(e, "step", "list")
    ...
    def close_step(self, step_id: int, step_update: StepUpdateInput) -> StepOutput:
        ...
        try:
            ...
            raise self._error_handler.handle_put_gql_error(e, "step", step_id)
    ...
    def get_step(self, step: str, iteration_id: int) -> StepOutput:
        ...
        try:
            ...
            raise self._error_handler.handle_get_gql_error(e, "step", step)
