/*! For license information please see 43a79fda.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[79042],{89833:(e,t,i)=>{i.d(t,{O:()=>h});var r=i(87480),n=i(86251),a=i(37500),o=i(33310),s=i(8636),l=i(51346),d=i(71260);const c={fromAttribute:e=>null!==e&&(""===e||e),toAttribute:e=>"boolean"==typeof e?e?"":null:e};class h extends n.P{constructor(){super(...arguments),this.rows=2,this.cols=20,this.charCounter=!1}render(){const e=this.charCounter&&-1!==this.maxLength,t=e&&"internal"===this.charCounter,i=e&&!t,r=!!this.helper||!!this.validationMessage||i,n={"mdc-text-field--disabled":this.disabled,"mdc-text-field--no-label":!this.label,"mdc-text-field--filled":!this.outlined,"mdc-text-field--outlined":this.outlined,"mdc-text-field--end-aligned":this.endAligned,"mdc-text-field--with-internal-counter":t};return a.dy`
  ...
  <span>${e.name}</span>
        ...
        <div class="content">
          ...
          <div>
            ...
            <div class="flex">
              ...
              ></ha-date-input>
              ${this._allDay?"":o.dy`<ha-time-input
                    .value=${i}
                    .locale=${this.hass.locale}
    ...
    `}},{kind:"field",key:"_getLocaleStrings",value(){return(0,l.Z)(((e,t)=>{const i=this.hass.config.time_zone;return{startDate:null==e?void 0:e.toLocaleDateString("en-CA",{timeZone:i}),startTime:null==e?void 0:e.toLocaleTimeString("en-GB",{timeZone:i}),endDate:null==t?void 0:t.toLocaleDateString("en-CA",{timeZone:i}),endTime:null==t?void 0:t.toLocaleTimeString("en-GB",{timeZone:i})}}))}},{kind:"method",key:"_handleSummaryChanged",value:function(e){this._summary=e.target.value}},{kind:"method",key:"_handleDescriptionChanged",value:function(e){this._description=e.target.value}},{kind:"method",key:"_handleRRuleChanged",value:function(e){this._rrule=e.detail.value}},{kind:"method",key:"_allDayToggleChanged",value:function(e){this._allDay=e.target.checked}},{kind:"method",key:"_startDateChanged",value:function(e){this._dtstart=new Date(e.detail.value+"T"+this._dtstart.toISOString().split("T")[1])}},{kind:"method",key:"_endDateChanged",value:function(e){this._dtend=new Date(e.detail.value+"T"+this._dtend.toISOString().split("T")[1])}},{kind:"method",key:"_startTimeChanged",value:function(e){this._dtstart=new Date(this._dtstart.toISOString().split("T")[0]+"T"+e.detail.value)}},{kind:"method",key:"_endTimeChanged",value:function(e){this._dtend=new Date(this._dtend.toISOString().split("T")[0]+"T"+e.detail.value)}},{kind:"method",key:"_calculateData",value:function(){const{startDate:e,startTime:t,endDate:i,endTime:n}=this._getLocaleStrings(this._dtstart,this._dtend),a={summary:this._summary,description:this._description,rrule:this._rrule,dtstart:"",dtend:""};return this._allDay?(a.dtstart=e,a.dtend=(0,r.Z)(new Date(this._dtend),1).toLocaleDateString("en-CA")):(a.dtstart=`${e}T${t}`,a.dtend=`${i}T${n}`),a}},{kind:"method",key:"_handleCalendarChanged",value:function(e){this._calendarId=e.detail.value}},{kind:"method",key:"_createEvent",value:async function(){if(this._summary&&this._calendarId){this._submitting=!0;try{await(0,h.fE)(this.hass,this._calendarId,this._calculateData())}catch(e){this._error=e?e.message:"Unknown error"}finally{this._submitting=!1}await this._params.updated(),this._params=void 0}else this._error=this.hass.localize("ui.components.calendar.event.not_all_required_fields")}},{kind:"method",key:"_saveEvent",value:async function(){}},{kind:"method",key:"_deleteEvent",value:async function(){this._submitting=!0;const e=this._params.entry,t=await(0,f.Y)(this,{title:this.hass.localize("ui.components.calendar.event.confirm_delete.delete"),text:e.recurrence_id?this.hass.localize("ui.components.calendar.event.confirm_delete.recurring_prompt"):this.hass.localize("ui.components.calendar.event.confirm_delete.prompt"),confirmText:e.recurrence_id?this.hass.localize("ui.components.calendar.event.confirm_delete.delete_this"):this.hass.localize("ui.components.calendar.event.confirm_delete.delete"),confirmFutureText:e.recurrence_id?this.hass.localize("ui.components.calendar.event.confirm_delete.delete_future"):void 0});if(void 0!==t){try{await(0,h.d1)(this.hass,this._calendarId,e.uid,e.recurrence_id||"",t)}catch(e){return void(this._error=e?e.message:"Unknown error")}finally{this._submitting=!1}await this._params.updated(),this._close()}else this._submitting=!1}},{kind:"method",key:"_close",value:function(){this._calendars=[],this._calendarId=void 0,this._params=void 0,this._dtstart=void 0,this._dtend=void 0,this._summary="",this._description="",this._rrule=void 0}},{kind:"get",static:!0,key:"styles",value:function(){return[u.yu,o.iv`
      ...
      `]}}]}}),o.oi)}))}}]);
//# sourceMappingURL=43a79fda.js.map