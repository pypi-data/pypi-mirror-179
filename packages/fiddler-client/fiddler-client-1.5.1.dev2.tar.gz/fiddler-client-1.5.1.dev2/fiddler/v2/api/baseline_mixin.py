...
from fiddler.v2.schema.baseline import CreateBaseline, ReadBaseline
...
class BaselineMixin:
    ...
    def get_baselines(self, project_id: str, model_id: str = None) -> List[ReadBaseline]:
        ...
        return parse_obj_as(List[ReadBaseline], items)

    @handle_api_error_response
    def get_baseline(self, project_id: str, baseline_id: str) -> ReadBaseline:
        ...
        return ReadBaseline.deserialize(response_handler)
    ...
    def add_baseline(
        ...
        if response.status_code == HTTPStatus.OK:
            ...
            return ReadBaseline.deserialize(APIResponseHandler(response))
