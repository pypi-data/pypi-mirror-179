depends = ('ITKPyBase', 'MeshToPolyData', 'ITKMesh', 'ITKImageGrid', 'ITKCommon', )
templates = (  ('BSplineGradientImageFilter', 'itk::BSplineGradientImageFilter', 'itkBSplineGradientImageFilterISS2FF', True, 'itk::Image< signed short,2 >,float,float'),
