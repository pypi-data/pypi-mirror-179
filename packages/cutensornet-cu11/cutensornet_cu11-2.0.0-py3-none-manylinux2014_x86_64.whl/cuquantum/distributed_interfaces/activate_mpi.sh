...
gcc -shared -std=c11 -fPIC -g -I${CUDA_PATH}/include -I../include -I${MPI_PATH}/include cutensornet_distributed_interface_mpi.c -o libcutensornet_distributed_interface_mpi.so
