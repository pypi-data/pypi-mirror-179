...
<h3 id="Uat_Breeze">Breeze Connect</h3>
...
<h3 id="Setup_env">Setup virtual environment in your Machine</h3>
...
<h3 id="Installing_client">Installing the client</h3>
You can install the latest release via pip

```
pip install --upgrade breeze-connect==1.0.26
```

Or, You can also install the specific release version via pip

```
pip install breeze-connect==1.0.26
```
<a href="#index">Back to Index</a>

<h3 id="Web_socket">Websocket Usage</h3>
...
Y : Market Level data<br>
Value of Y can be :<br>
...
<h3 id="historical_data">Get Historical Data for Futures</h3>
...
<p>Note: Use this method to find ICICI specific stock codes / token </p><br>
<a href="#index">Back to Index</a>