...
import apricity.settings as _s
import apricity.modules.Log as _log
...
class Main:
    ...
    def prep(self):
        ...
        master_blueprint.register_blueprint(_services.home_blueprint)
...
# import apricity.services.auth.routes as _auth
