...
class WeakNetworkConfig(object):
    ...
    def connect_wifi(self, device_serial, platform='ios'):
        ...
        if self.platform == 'ios':
            ...
            return self._connect_android(device_serial)
    ...
    def _connect_android(self, device_serial):
        self.serail = device_serial
        ret = self._stf.toggleAndroidWifi(device_serial, "1", wifiname=self._wifi_name, wifipass=self._wifi_password)
        ip = ret.get("ip", None)
