...
class HelmertFactory(Factory):
    ...
    def from_ref_frame(cls, ref_frame: Union[Reference, str]):
        if ref_frame == Reference.NAD83CSRS:
            ...
            return cls(0.97300, 0.00000, -1.90720, 0.00000, -0.42090, 0.00000, -26.58160, -0.05320,
                       -0.00010, 0.74230, -11.24920, 0.03160, -7.40000, 0.00000, 2010)

        elif ref_frame == Reference.ITRF89:
            return cls(0.96800, 0.00000, -1.94320, 0.00000, -0.44490, 0.00000, -26.48160, -0.05320,
                       -0.00010, 0.74230, -11.24920, 0.03160, -4.30000, 0.00000, 2010)

        elif ref_frame == Reference.ITRF90:
            return cls(0.97300, 0.00000, -1.91920, 0.00000, -0.48290, 0.00000, -26.48160, -0.05320,
                       -0.00010, 0.74230, -11.24920, 0.03160, -0.90000, 0.00000, 2010)

        elif ref_frame == Reference.ITRF91:
            return cls(0.97100, 0.00000, -1.92320, 0.00000, -0.49890, 0.00000, -26.48160, -0.05320,
                       -0.00010, 0.74230, -11.24920, 0.03160, -0.60000, 0.00000, 2010)

        elif ref_frame == Reference.ITRF92:
            return cls(0.98300, 0.00000, -1.90920, 0.00000, -0.50490, 0.00000, -26.48160, -0.05320,
                       -0.00010, 0.74230, -11.24920, 0.03160, 0.80000, 0.00000, 2010)

        elif ref_frame == Reference.ITRF93:
            return cls(1.04880, 0.00290, -1.91100, -0.00040, -0.51550, -0.00080, -23.67160, 0.05680,
                       3.37990, 0.93230, -11.38920, -0.01840, -0.40000, 0.00000, 2010)

        elif ref_frame == Reference.ITRF94:
            return cls(0.99100, 0.00000, -1.90720, 0.00000, -0.51290, 0.00000, -26.48160, -0.05320,
                       -0.00010, 0.74230, -11.24920, 0.03160, 0.00000, 0.00000, 2010)
            ...
            return cls(0.99790, 0.00069, -1.90871, -0.00010, -0.47877, 0.00186, -26.78138, -0.06667,
                       0.42027, 0.75744, -11.19206, 0.03133, -3.43109, -0.19201, 2010)

        elif ref_frame == Reference.ITRF00:
            return cls(1.00460, 0.00069, -1.91041, -0.00070, -0.51547, 0.00046, -26.78138, -0.06667,
                       0.42027, 0.75744, -10.93206, 0.05133, -1.75109, -0.18201, 2010)

        elif ref_frame == Reference.ITRF05:
            return cls(1.00270, 0.00049, -1.91021, -0.00060, -0.53927, -0.00134, -26.78138,
                       -0.06667, 0.42027, 0.75744, -10.93206, 0.05133, -0.55109, -0.10201, 2010)

        elif ref_frame == Reference.ITRF08:
            return cls(1.00370, 0.00079, -1.91111, -0.00060, -0.54397, -0.00134, -26.78138,
                       -0.06667, 0.42027, 0.75744, -10.93206, 0.05133, 0.38891, -0.10201, 2010)
