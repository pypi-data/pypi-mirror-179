...
`;!function(e,t,r,i){var n=l();if(i)for(var o=0;o<i.length;o++)n=i[o](n);var a=t((function(e){n.initializeInstanceElements(e,s.elements)}),r),s=n.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},i=0;i<e.length;i++){var n,o=e[i];if("method"===o.kind&&(n=t.find(r)))if(u(o.descriptor)||u(n.descriptor)){if(p(o)||p(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(p(o)){if(p(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}d(o,n)}else t.push(o)}return t}(a.d.map(c)),e);n.initializeClassElements(a.F,s.elements),n.runClassFinishers(a.F,s.finishers)}([(0,a.Mo)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"field",key:s.gA,value:void 0},{kind:"method",key:"scrollToPos",value:function(e,t){var r;null===(r=this.contentElement)||void 0===r||r.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return o.dy`<slot name="heading"> ${y(g(r.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"field",static:!0,key:"styles",value:()=>[n.W,o.iv`
    ...
    `}},{kind:"method",key:"_handleTargetChanged",value:function(e){this._target=e.target.value,this.requestUpdate("_target")}},{kind:"method",key:"_playExample",value:async function(){var e;const t=null===(e=this._messageInput)||void 0===e?void 0:e.value;if(t)if(this._message=t,"browser"===this._target){const e=new Audio;e.play(),this._playBrowser(t,e)}else this.hass.callService("tts","cloud_say",{entity_id:this._target,message:t})}},{kind:"method",key:"_createAutomation",value:function(){const e=this._messageInput.value;this._message=e,(0,u.Ip)({action:[{service:"tts.cloud_say",data:{entity_id:this._target,message:e}}]}),this.closeDialog()}},{kind:"method",key:"_playBrowser",value:async function(e,t){this._loadingExample=!0;const r=this._params.defaultVoice[0],i=this._params.defaultVoice[1];let n;try{n=(await(0,h.aT)(this.hass,{platform:"cloud",message:e,language:r,options:{gender:i}})).path}catch(e){return this._loadingExample=!1,void(0,m.Ys)(this,{text:`Unable to load example. ${e.error||e.body||e}`,warning:!0})}t.src=n,t.addEventListener("canplaythrough",(()=>{t.play()})),t.addEventListener("playing",(()=>{this._loadingExample=!1})),t.addEventListener("error",(()=>{(0,m.Ys)(this,{title:"Error playing audio."}),this._loadingExample=!1}))}},{kind:"get",static:!0,key:"styles",value:function(){return[y.yu,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=6f634f3c.js.map