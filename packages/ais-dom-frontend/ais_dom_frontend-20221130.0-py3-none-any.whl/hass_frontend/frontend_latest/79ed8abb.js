...
>
  ...
  ${e.icon}
    ...
    `}},{kind:"method",key:"_openedChanged",value:async function(e){if(this._opened=e.detail.value,this._opened&&!v){const e=await i.e(71639).then(i.t.bind(i,71639,19));m=e.default.map((e=>({icon:`mdi:${e.name}`,keywords:e.keywords}))),v=!0,this.comboBox.filteredItems=m,Object.keys(o.g).forEach((e=>{this._loadCustomIconItems(e)}))}}},{kind:"method",key:"_loadCustomIconItems",value:async function(e){try{const t=o.g[e].getIconList;if("function"!=typeof t)return;const i=(await t()).map((t=>{var i;return{icon:`${e}:${t.name}`,keywords:null!==(i=t.keywords)&&void 0!==i?i:[]}}));m.push(...i),this.comboBox.filteredItems=m}catch(t){console.warn(`Unable to load icon list for ${e} iconset`)}}},{kind:"method",key:"shouldUpdate",value:function(e){return!this._opened||e.has("_opened")}},{kind:"method",key:"_valueChanged",value:function(e){e.stopPropagation(),this._setValue(e.detail.value)}},{kind:"method",key:"_setValue",value:function(e){this.value=e,(0,s.B)(this,"value-changed",{value:this._value},{bubbles:!1,composed:!1})}},{kind:"method",key:"_filterChanged",value:function(e){const t=e.detail.value.toLowerCase();if(t.length>=2){const e=[],i=[];m.forEach((r=>{r.icon.includes(t)?e.push(r):r.keywords.some((e=>e.includes(t)))&&i.push(r)})),e.push(...i),e.length>0?this.comboBox.filteredItems=e:this.comboBox.filteredItems=[{icon:t,keywords:[]}]}else this.comboBox.filteredItems=m}},{kind:"get",key:"_value",value:function(){return this.value||""}},{kind:"get",static:!0,key:"styles",value:function(){return r.iv`
      ha-icon,
      ha-svg-icon {
...
//# sourceMappingURL=79ed8abb.js.map