...
def all_continous_statistics(df_cont):
    """
...
def eda_categoric_graph(df_cat):
    """
...
def eda_continous_graph(df_cont,mode='density'):
    """
...
def preprocessing_strong_corr(df,lim_inf = 0.3, lim_sup = 1,drop_dupli=True):
    """
...
def preprocessing_ranking_mi(mutual_selector, predictors_df, modo = 'tabla'):
    """
...
def preprocessing_ranking_rfe(predictoras,rfe_ranking):
    """
...
def preprocessing_ranking_per(predictoras,permutacion,modo='tabla'):
    """
...
def preprocessing_ranking_tot(rank_mi, rank_rfe,rank_per,modo='tabla'):
    """
...
def outliers_standard_desv(variable, x = 4):
    """
...
def TS_invert_transformation(X_train, pred):
    """
...
def TS_grangers_causality_matrix(X_train_transformed, test = 'ssr_chi2test', verbose=False,maxlag=15):
    """
...
def TS_dickey_fuller_statistics(X_train):
    """
