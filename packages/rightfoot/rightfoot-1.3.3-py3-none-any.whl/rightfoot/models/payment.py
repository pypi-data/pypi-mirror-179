...
class Payment(object):
    ...
    def __init__(self, uuid=None, loan_uuid=None, beneficiary_uuid=None, payment_amount=None, status=None, status_reason=None, description=None, time_created=None, time_completed=None, withdrawal_transfer_uuid=None, return_transfer_uuid=None):  # noqa: E501
