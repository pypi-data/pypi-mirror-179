   ...
   def config(self) -> list[ConfigProperty]:
      ...
      return [
         ...
         ConfigProperty('password', ConfigAttributeType.STRING, True, False,
                        ...
                        example='oracle'),
         ConfigProperty('default_replication_method', ConfigAttributeType.STRING, True, False,
         ...
         ConfigProperty('filter_schemas', ConfigAttributeType.STRING, False, False,
                        ...
                        example='C##CUSTOMERS'),
         ConfigProperty('service_name', ConfigAttributeType.STRING, True, False,
                        description='Oracle DB service name',
                        example='ORCLCDB'),
         ConfigProperty('pdb_name', ConfigAttributeType.STRING, False, False,
                        description='Oracle portable db name',
                        example='ORCLPDB1'),
         ConfigProperty('multitenant', ConfigAttributeType.BOOLEAN, False, False,
                        description='Is Oracle DB is multi tennat or not',
                        example='true'),
         ConfigProperty('scn_window_size', ConfigAttributeType.INT, False, False,
