        ...
        **kwargs,
        ...
        for kp, val in self.kps.items():
            ...
            for operation in val['operations']:
                if any(category == operation['subject_category'] for category in subject_category) and any(predicate == operation['predicate'] for predicate in predicate) and any(category == operation['object_category'] for category in object_category):
