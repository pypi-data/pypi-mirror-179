...
from typing import List, Optional, Dict, Iterator, AsyncIterator, Tuple, Any, Union
...
class ArgPortInput(PortInputTrait, BaseModel):
...
class ReturnPortInput(PortInputTrait, BaseModel):
    identifier: Optional[Identifier]
    "The identifier"
    key: str
    "The key of the arg"
