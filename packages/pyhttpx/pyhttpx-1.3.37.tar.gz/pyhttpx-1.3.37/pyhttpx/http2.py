...
s1 = bytes.fromhex('')
...
class Http2Session(object):
    def chrome105_ja3(self):
        ja3 = '771,35466-4865-4866-4867-49195-49199-49196-49200-52393-52392-49171-49172-156-157-47-53,51914-0-23-65281-10-11-35-16-5-13-18-51-45-43-27-43690-21,43690-29-23-24,0'
        exts_payload = {43690: '\x00'}

        return ja3, exts_payload
    def __init__(self, ja3=None, exts_payload=None):
        ...
        if ja3:
            ...
            self.ja3,self.exts_payload = self.chrome105_ja3()
        ...
        self.stream_id = 15
        self.settings_msg = bytes.fromhex('')
    ...
    def send(self, req, msg, update_cookies):
        ...
        print('requet id', self.stream_id)
        while 1:
        ...
        print('respone id' , response.stream_id)
...
if __name__ == '__main__':
    ...
    #url="https://www.ti.com/product-folders/customreel/inventoryforecast"
    proxies = None
    headers={
