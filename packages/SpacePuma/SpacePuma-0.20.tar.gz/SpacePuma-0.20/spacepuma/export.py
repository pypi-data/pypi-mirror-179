...
class export(widget_base):
    ...
    def setup_buttons(self):
        ...
        def data_select(self,param_selects,index):
            ...
            def func(b,self=self):
                ...
                if param_selects[index].value is None: return
                    ...
                    self.place_menu(self.param_menu,param_selects[:index+1])
                    return
        ...
        for index,select in enumerate(param_selects):
            select.observe(data_select(self,param_selects,index))
        ...
        return [self.export_path_text,self.export_data_button,self.export_all_button,self.save_button,self.dpi_text],[self.export_data_button],param_selects
