...
class PQDataset:
    ...
    def clean_up_data(self,
        ...
        def parse_testareas_variables(df: pd.DataFrame) -> List[str]:
            
            testarea_variables = self.__return_config_parameter('testarea_variables')
            testarea_variables_new = []
            
            for var in testarea_variables:
                if var in df.columns:
                    testarea_variables_new.append(var)
            
            return testarea_variables_new
        ...
        if remove_testareas:
            ...
            testarea_variables = parse_testareas_variables(df)
