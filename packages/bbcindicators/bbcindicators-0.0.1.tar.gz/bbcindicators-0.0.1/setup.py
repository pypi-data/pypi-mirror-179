...
setuptools.setup(
    name="bbcindicators",                     # This is the name of the package
    ...
    py_modules=["bbc"],             # Name of the python package
    package_dir={'':'bbc/src'},     # Directory of the source code of the package
