...
class MobileDarknet(BaseModule):
    ...
    def DN(in_channels, out_channels, momentum=0.01, relu=default_relu):
        ...
        Examples:
            ...
            >>> print(backbone)
            Sequential(
              (1_convbatch): Conv2dBatchReLU(3, 16, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), LeakyReLU(negative_slope=0.1, inplace=True))
        ...
        """
        return (
            ('1_convbatch',     lnl.Conv2dBatchReLU(in_channels, 16, 3, 2, 1, relu=relu, momentum=momentum)),
            ('2_convdw',        lnl.Conv2dDepthWise(16, 32, 3, 2, 1, relu=relu, momentum=momentum)),
            ('3_convdw',        lnl.Conv2dDepthWise(32, 64, 3, 2, 1, relu=relu, momentum=momentum)),
            ('4_convdw',        lnl.Conv2dDepthWise(64, 128, 3, 2, 1, relu=relu, momentum=momentum)),
            ('5_convdw',        lnl.Conv2dDepthWise(128, 256, 3, 2, 1, relu=relu, momentum=momentum)),
            ('6_convdw',        lnl.Conv2dDepthWise(256, out_channels, 3, 1, 1, relu=relu, momentum=momentum)),
        )
    ...
    def DN_19(in_channels, out_channels, momentum=0.01, relu=default_relu):
        ...
        Examples:
            ...
            >>> print(backbone)
            Sequential(
              (1_convbatch): Conv2dBatchReLU(3, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), LeakyReLU(negative_slope=0.1, inplace=True))
              ...
              (4_convbatch): Conv2dBatchReLU(128, 64, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0), LeakyReLU(negative_slope=0.1, inplace=True))
              ...
              (7_convbatch): Conv2dBatchReLU(256, 128, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0), LeakyReLU(negative_slope=0.1, inplace=True))
              ...
              (10_convbatch): Conv2dBatchReLU(512, 256, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0), LeakyReLU(negative_slope=0.1, inplace=True))
              (11_convdw): Conv2dDepthWise(256, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), LeakyReLU(negative_slope=0.1, inplace=True))
              (12_convbatch): Conv2dBatchReLU(512, 256, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0), LeakyReLU(negative_slope=0.1, inplace=True))
              ...
              (16_convbatch): Conv2dBatchReLU(1024, 512, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0), LeakyReLU(negative_slope=0.1, inplace=True))
              (17_convdw): Conv2dDepthWise(512, 1024, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), LeakyReLU(negative_slope=0.1, inplace=True))
              (18_convbatch): Conv2dBatchReLU(1024, 512, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0), LeakyReLU(negative_slope=0.1, inplace=True))
        ...
        """
        return (
            ('1_convbatch',     lnl.Conv2dBatchReLU(in_channels, 32, 3, 2, 1, relu=relu, momentum=momentum)),
            ('2_convdw',        lnl.Conv2dDepthWise(32, 64, 3, 2, 1, relu=relu, momentum=momentum)),
            ('3_convdw',        lnl.Conv2dDepthWise(64, 128, 3, 1, 1, relu=relu, momentum=momentum)),
            ('4_convbatch',     lnl.Conv2dBatchReLU(128, 64, 1, 1, 0, relu=relu, momentum=momentum)),
            ('5_convdw',        lnl.Conv2dDepthWise(64, 128, 3, 2, 1, relu=relu, momentum=momentum)),
            ('6_convdw',        lnl.Conv2dDepthWise(128, 256, 3, 1, 1, relu=relu, momentum=momentum)),
            ('7_convbatch',     lnl.Conv2dBatchReLU(256, 128, 1, 1, 0, relu=relu, momentum=momentum)),
            ('8_convdw',        lnl.Conv2dDepthWise(128, 256, 3, 2, 1, relu=relu, momentum=momentum)),
            ('9_convdw',        lnl.Conv2dDepthWise(256, 512, 3, 1, 1, relu=relu, momentum=momentum)),
            ('10_convbatch',    lnl.Conv2dBatchReLU(512, 256, 1, 1, 0, relu=relu, momentum=momentum)),
            ('11_convdw',       lnl.Conv2dDepthWise(256, 512, 3, 1, 1, relu=relu, momentum=momentum)),
            ('12_convbatch',    lnl.Conv2dBatchReLU(512, 256, 1, 1, 0, relu=relu, momentum=momentum)),
            ('13_convdw',       lnl.Conv2dDepthWise(256, 512, 3, 1, 1, relu=relu, momentum=momentum)),
            ('14_max',          nn.MaxPool2d(2, 2)),
            ('15_convdw',       lnl.Conv2dDepthWise(512, 1024, 3, 1, 1, relu=relu, momentum=momentum)),
            ('16_convbatch',    lnl.Conv2dBatchReLU(1024, 512, 1, 1, 0, relu=relu, momentum=momentum)),
            ('17_convdw',       lnl.Conv2dDepthWise(512, 1024, 3, 1, 1, relu=relu, momentum=momentum)),
            ('18_convbatch',    lnl.Conv2dBatchReLU(1024, 512, 1, 1, 0, relu=relu, momentum=momentum)),
            ('19_convdw',       lnl.Conv2dDepthWise(512, out_channels, 3, 1, 1, relu=relu, momentum=momentum)),
        )
    ...
    def DN_53(in_channels, out_channels, momentum=0.01, relu=default_relu):
        ...
        return (
            ...
            ('2_convbatch',         lnl.Conv2dDepthWise(32, 64, 3, 2, 1, relu=relu, momentum=momentum)),
            ('3_residual',          lnl.Residual(
                                    lnl.Conv2dBatchReLU(64, 32, 1, 1, 0, relu=relu, momentum=momentum),
                                    lnl.Conv2dDepthWise(32, 64, 3, 1, 1, relu=relu, momentum=momentum),
            )),
            ('4_convbatch',         lnl.Conv2dDepthWise(64, 128, 3, 2, 1, relu=relu, momentum=momentum)),
            ('5_residual',          lnl.Residual(
                                    lnl.Conv2dBatchReLU(128, 64, 1, 1, 0, relu=relu, momentum=momentum),
                                    lnl.Conv2dDepthWise(64, 128, 3, 1, 1, relu=relu, momentum=momentum),
            )),
            ('6_residual',          lnl.Residual(
                                    lnl.Conv2dBatchReLU(128, 64, 1, 1, 0, relu=relu, momentum=momentum),
                                    lnl.Conv2dDepthWise(64, 128, 3, 1, 1, relu=relu, momentum=momentum),
            )),
            ('7_convbatch',         lnl.Conv2dDepthWise(128, 256, 3, 2, 1, relu=relu, momentum=momentum)),
            ('8_residual',          lnl.Residual(
                                    lnl.Conv2dBatchReLU(256, 128, 1, 1, 0, relu=relu, momentum=momentum),
                                    lnl.Conv2dDepthWise(128, 256, 3, 1, 1, relu=relu, momentum=momentum),
            )),
            ...
            ('16_convbatch',        lnl.Conv2dDepthWise(256, 512, 3, 2, 1, relu=relu, momentum=momentum)),
            ('17_residual',         lnl.Residual(
                                    lnl.Conv2dBatchReLU(512, 256, 1, 1, 0, relu=relu, momentum=momentum),
                                    lnl.Conv2dDepthWise(256, 512, 3, 1, 1, relu=relu, momentum=momentum),
            )),
            ...
            ('25_convbatch',        lnl.Conv2dDepthWise(512, out_channels, 3, 2, 1, relu=relu, momentum=momentum)),
            ('26_residual',         lnl.Residual(
                                    lnl.Conv2dBatchReLU(out_channels, 512, 1, 1, 0, relu=relu, momentum=momentum),
                                    lnl.Conv2dDepthWise(512, out_channels, 3, 1, 1, relu=relu, momentum=momentum),
            )),
