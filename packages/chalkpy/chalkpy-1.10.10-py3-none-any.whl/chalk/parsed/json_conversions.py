...
from chalk.streams.types import StreamResolverParam, StreamResolverParamKeyedState, StreamResolverParamMessage
...
def convert_type_to_gql(t: Any):
    if isinstance(t, StreamResolver):
        return UpsertStreamResolverGQL(
            ...
            inputs=[convert_type_to_gql(i) for i in t.signature.params],
        )
