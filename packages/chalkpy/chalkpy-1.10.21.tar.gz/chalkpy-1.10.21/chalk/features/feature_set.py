...
#     #
#     # Pylance is able to parse through this lambda and type Features as
#     # Type[Features] | Type[object], which causes typing issues later because
#     # object is not subscriptable. Hopefully IntelliJ ignroes the if TYPE_CHECKING
#     # above
# n.b. 12/4/22: above change seemed to regress intellij.
Features: TypeAlias = (lambda xyz: FeaturesImpl if xyz > 1 else object)(2)
