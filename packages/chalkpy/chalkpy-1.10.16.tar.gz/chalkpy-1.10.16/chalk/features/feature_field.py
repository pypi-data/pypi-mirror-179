...
from typing import TYPE_CHECKING, Any, Callable, List, Optional, Sequence, Set, Tuple, Type, TypeVar, Union, cast
...
class Feature:
    ...
    def window_duration(self):
        if self._window_duration is None:
            raise ValueError("Feature {self} is now a windowed pseudofeature")
