...
from typing import TYPE_CHECKING, Any, Callable, List, Optional, Set, Tuple, Type, TypeVar, Union, cast
...
class Feature:
    ...
    def is_windowed(self):
        return self.is_scalar and isinstance(self.typ.underlying, Windowed)
