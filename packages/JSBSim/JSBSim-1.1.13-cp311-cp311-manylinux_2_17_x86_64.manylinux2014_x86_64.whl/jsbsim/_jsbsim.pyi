...
class FGFDMExec(_jsbsim.FGJSBBase):
    ...
    def load_ic(self, unicoderstfile: str, booluseStoredPath: bool) -> bool: ...
    ...
    def set_output_filename(self, n: int, unicodefname: str) -> bool: ...
...
def _append_xml(unicodename: str) -> str: ...
