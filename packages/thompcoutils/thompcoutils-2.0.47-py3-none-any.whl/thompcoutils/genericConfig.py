...
class GenericAppConfig(config_utils.ConfigManager):
    ...
    def _init(self, arg_parser: GenericArgParser, app_name: str):
        ...
        if self.has_logging:
            ...
            if arg_parser.log_level:
                logging.getLogger().setLevel(logging.getLevelName(arg_parser.log_level))
        ...
        if self.has_email:
            ...
            self.recipients = self.read_entry(
                header, 'email_recipients', 'recipient1@gmail.com, recipient2@yahoo.com',
