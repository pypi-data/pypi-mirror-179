...
def get_image_label_info(dataset_element, dataset_elements, img_size, all_labels, annotations, settings, is_train,
                         ignore_data_errors, apply_automl_train_augmentations=True, apply_mosaic=True):
    ...
    :param ignore_data_errors: flag to specify if an error occurring when loading an image is silently ignored
    :type ignore_data_errors: bool
    :param apply_automl_train_augmentations: flag to specify if automl training augmentations should be applied
    :type apply_automl_train_augmentations: bool
    :param apply_mosaic: flag to specify if mosaic augmentations should be applied
    :type apply_mosaic: bool
    :return: tuple (Image, labels, image path)
    :rtype: tuple
    """

    mosaic = is_train and apply_mosaic
    augment = is_train and apply_automl_train_augmentations
