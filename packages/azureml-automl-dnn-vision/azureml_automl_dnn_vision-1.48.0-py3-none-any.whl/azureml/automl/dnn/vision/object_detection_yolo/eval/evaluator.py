...
class YoloEvaluator(OdEvaluator):
    ...
    def __init__(self, settings, val_index_map, dataset_processing_type, dataset_wrapper=None) -> None:
        ...
        super().__init__(settings, val_index_map, dataset_processing_type, dataset_wrapper=dataset_wrapper)
