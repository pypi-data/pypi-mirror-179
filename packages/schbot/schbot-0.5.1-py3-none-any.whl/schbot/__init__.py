...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        self.status = ' 💎 {party_size}/16 Use Code XNXX 💎'
        ...
        self.server = server
        self.welcome_message =  " Use Code XNXX in the Item Shop (#EpicPartner)\n Create own your bot : https://aeroz.cousinfn.com \n Join my discord : https://discord.gg/PVsFJMru \n"
    ...
    async def status_change(self) -> None:
        ...
        await self.set_presence("💎 {party_size}/16 Use Code XNXX 💎")
