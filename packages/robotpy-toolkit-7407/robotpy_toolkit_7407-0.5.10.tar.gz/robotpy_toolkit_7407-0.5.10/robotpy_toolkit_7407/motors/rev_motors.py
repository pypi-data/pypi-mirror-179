...
class SparkMax(PIDMotor):
    ...
    __alt_encoder: SparkMaxAlternateEncoder
    ...
    def init_alternate_encoder(self):
        self.__alt_encoder = self._motor.getAlternateEncoder(encoderType=SparkMaxAlternateEncoder.Type.kQuadrature,
                                                             countsPerRev=80)

    def get_alternate_position(self):
        return self.__alt_encoder.getPosition()
