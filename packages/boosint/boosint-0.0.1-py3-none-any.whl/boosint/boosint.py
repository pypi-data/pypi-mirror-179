from boosint.blackbird import findUsername
import asyncio
import os
import shutil
import requests
...
if __name__ == "__main__":
    try:
        ...
        try:
            os.system(f"maigret -J simple --no-progressbar {username} > l.txt")
        except:
            pass
        os.remove("l.txt")
        ############################### GitRecon ###############################
        try:
            from boosint.GitRecon.gitrecon import gitrecon
        ...
        ## Social Media
        from boosint.modules import reddit, pinterest, tiktok, twitter, github, gravatar, scratch
        ...
        print("[+] Twitter")
        ## Get Other Info
        from boosint.modules.get_info import gmail, yahoo, hotmail
        gma = gmail(username)
        print("[+] Gmail")
        yah = yahoo(username)
        print("[+] Yahoo")
        ...
        from boosint.modules.thatsthem import thatsthem
        # Name
