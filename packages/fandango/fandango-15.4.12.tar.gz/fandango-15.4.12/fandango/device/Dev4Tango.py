...
class Dev4Tango(PyTango.LatestDeviceImpl, log.Logger):
    ...
    def __init__(self, cl, name, use_tango_logging = False):
        self.call__init__(PyTango.LatestDeviceImpl, cl, name)
        self.init_logger(use_tango = use_tango_logging)
    ...
    def get_name(self,name=''):
        try:
            name =  PyTango.LatestDeviceImpl.get_name(self)
            return str(name)
        except:
