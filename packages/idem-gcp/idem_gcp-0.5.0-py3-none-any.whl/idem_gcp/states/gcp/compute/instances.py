...
async def present(
        ...
        example_resource_name:
          ...
          - disks:
            - auto_delete: true
              ...
              source: https://www.googleapis.com/compute/v1/projects/tango-gcp/zones/us-central1-a/disks/example_disk_1
              mode: READ_WRITE
              type: PERSISTENT
              disk_size_gb: '10'
              index: 0
    ...
    if not resource_id:
        resource_id = (ctx.get("old_state") or {}).get(
            "resource_id"
        ) or f"projects/{project}/zones/{zone}/instances/{name}"
    ...
    if resource_id:
        ...
        if old_get_ret["ret"]:
            ...
            # so there is no need to run the code for crate or update below again and we stop here
            if ctx.get("rerun_data"):
