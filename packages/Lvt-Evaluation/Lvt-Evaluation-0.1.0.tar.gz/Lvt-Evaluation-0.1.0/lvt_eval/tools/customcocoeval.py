...
class CustomCOCOeval(COCOeval):
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            stats = np.zeros((14,))
            stats[0] = _summarize(1) # AP_all
            stats[1] = _summarize(1, iouThr=.5, maxDets=self.params.maxDets[2]) # AP_50
            stats[2] = _summarize(1, iouThr=.75, maxDets=self.params.maxDets[2]) # AP_75
            stats[3] = _summarize(1, areaRng='small', maxDets=self.params.maxDets[2]) # AP_small
            stats[4] = _summarize(1, areaRng='medium', maxDets=self.params.maxDets[2]) # AP_medium
            stats[5] = _summarize(1, areaRng='large', maxDets=self.params.maxDets[2]) # AP_large
            ...
            stats[9] = _summarize(0, areaRng='small', maxDets=self.params.maxDets[2]) # AR_small
            stats[10] = _summarize(0, areaRng='medium', maxDets=self.params.maxDets[2]) # AR_medium
            stats[11] = _summarize(0, areaRng='large', maxDets=self.params.maxDets[2]) # AR_large
