...
from telefone.bot.dispatch.return_manager.message import MessageReturnManager
from telefone.bot.dispatch.view.abc import ABCView
from telefone.bot.updates import BotUpdateType, MessageUpdate
from telefone.modules import logger

if TYPE_CHECKING:
    from telefone.api import ABCAPI, API
    from telefone.bot.states.dispenser.abc import ABCStateDispenser
