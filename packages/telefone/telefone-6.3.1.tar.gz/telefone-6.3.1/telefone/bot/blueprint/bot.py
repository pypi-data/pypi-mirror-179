...
from telefone.bot.blueprint.abc import ABCBlueprint
from telefone.bot.dispatch.labelers.default import BotLabeler
from telefone.bot.dispatch.router.bot import BotRouter
from telefone.modules import logger

if TYPE_CHECKING:
    from telefone.api import ABCAPI
    from telefone.bot.bot import Bot
    from telefone.bot.polling.abc import ABCPolling
    from telefone.bot.states import ABCStateDispenser
