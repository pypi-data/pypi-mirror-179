...
if __name__ == '__main__':
    ...
    test_list.appendRow(
        [QStandardItem('Russia'), QStandardItem('127.0.0.1'), QStandardItem('57094'), QStandardItem('16:20:34')])
    test_list.appendRow(
        [QStandardItem('Чиполино'), QStandardItem('127.0.0.1'), QStandardItem('57099'), QStandardItem('16:22:11')])
