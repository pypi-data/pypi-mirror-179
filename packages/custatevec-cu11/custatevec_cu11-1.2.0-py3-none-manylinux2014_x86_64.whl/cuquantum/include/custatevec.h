...
/** @file custatevec.h
 *  @details custatevec API Version 1.2.0.13
 */
 ...
 *  data type is specified by a \p cudaDataType_t constant. It's the users' responsibility to manage
...
#define CUSTATEVEC_VER_MINOR 2 //!< cuStateVec minor version.
#define CUSTATEVEC_VER_PATCH 0 //!< cuStateVec patch version.
#define CUSTATEVEC_VERSION 1200 //!< cuStateVec Version.
