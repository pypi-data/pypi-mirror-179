...
from Belrub.encryption import encryption
import datetime
import urllib
...
__copyright__ = "Copyright (C) 2022 BeLectron BoT\n     ‌‌‌ChanneL: https://rubika.ir/BeL_BoT"
__BeLectron__ = "BeLectron BoT"


class Token:
	def __init__( self, auth ,app_name =__BeLectron__, displayWelcome = True ):
		if displayWelcome : print(f"     ⫸ ‌‌‌Library version {__version__}\n\n     ‌‌{__copyright__}\n\n     ‌‌‌Activating please be patient . . .")
		self.auth = auth
