...
result_at_depth_2 = {
    ...
    "Plant_a": "F[+F]F[-F]F[+F[+F]F[-F]F]F[+F]F[-F]F[-F[+F]F[-F]F]F[+F]F[-F" "]F",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"F": "V", "X": "FX+FX+FXFY-FY-", "Y": "+FX+FXFY-FY-FY"},
        ),
        ("F=|[+F]|[-F]+F", {"F": "|[+F]|[-F]+F"}),
        ({"X ": " X+YF+", " Y": "-FX-Y "}, {"X": "X+YF+", "Y": "-FX-Y"}),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ("X ; X+YF+, Y ; -FX-Y", {"X": "X+YF+", "Y": "-FX-Y"}),
        ("X to X+yF+; y to -fX-y", {"X": "X+YF+", "Y": "-FX-Y"}),
        (
            "X - FX+FX+FXFY-FY-; Y - +FX+FXFY-FY-FY, F=  V",
            {"F": "V", "X": "FX+FX+FXFY-FY-", "Y": "+FX+FXFY-FY-FY"},
        ),
