...
PROMPT = open("{}/data/prompt_gpt3_moments.txt".format(ROOT_PATH), encoding="utf8").read()
# Instagram
...
TEMPLATES_DM = list(pd.read_json("{}/data/alcohorithm-dm-templates.json".format(ROOT_PATH))["text"])
TEMPLATES_RP = pd.read_json("{}/data/alcohorithm-response-templates.json".format(ROOT_PATH))
