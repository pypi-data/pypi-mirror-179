    ...
    new_tools = [
        {
            ...
            "Target URL": f"https://www.my.seeq.com/data-lab/{sdl_project1.id}/apps/my_tool.ipynb",
            "Icon": "fa fa-bell"},
        {
            "Name": f'Your {name}',
            "Description": "this is an awesome tool",
            "Target URL": f"https://www.my.seeq.com/data-lab/{sdl_project2.id}/apps/tool2.ipynb",
            "Icon": "fa fa-bars"}]
