...
class DataColumnTypes(sgqlc.types.Enum):
    ...
    * `PERCENTAGE`None
    '''
    __schema__ = schema
    __choices__ = ('CHART', 'DATE_TIME', 'NUMERIC', 'PERCENTAGE', 'TEXT')
...
class ExecDashboardMetrics(sgqlc.types.Enum):
    ...
    * `USER_APP_VIEWS_COUNTS`None
    '''
    __schema__ = schema
    __choices__ = ('FIELD_MONITOR_UPTIME_PCT', 'FRESHNESS_UPTIME_PCT', 'INCIDENTS_CLASSIFIED_COUNTS', 'INCIDENTS_COUNTS', 'INCIDENTS_COUNTS_BY_TABLE', 'INCIDENTS_MEAN_TIME_TO_FIRST_RESPONSE', 'INCIDENTS_MEAN_TIME_TO_RESOLUTION', 'MONITORS_CREATED_COUNT', 'SQL_RULES_UPTIME_PCT', 'STACK_SUMMARY', 'TABLES_COUNT', 'USER_APP_VIEWS_COUNTS', 'USER_VISITS_COUNTS', 'VOLUME_UPTIME_PCT')
...
class Account(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'uuid', 'name', 'created_on', 'config', 'allow_non_sso_login', 'data_share', 'notification_settings', 'data_collectors', 'users', 'user_invites', 'warehouses', 'bi', 'connections', 'tableau_accounts', 'slack_credentials', 'slack_channels', 'slack_msg_details', 'resources', 'account_domains', 'slack_credentials_v2', 'identity_provider', 'active_collection_regions', 'internal_notifications')
...
class AccountNotificationSetting(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'uuid', 'created_by', 'created_time', 'last_updated_by', 'last_update_time', 'type', 'recipient', 'recipients', 'anomaly_types', 'incident_sub_types', 'extra', 'routing_rules', 'custom_message', 'notification_schedule_type', 'digest_settings', 'specification_rule', 'slack_msg_details', 'recipient_display_name', 'recipients_display_names', 'matching_incidents')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
...
class ExecDashboardTable(sgqlc.types.Type):
    ...
    __schema__ = schema
    __field_names__ = ('table', 'data_columns', 'data_rows', 'has_error')
...
class IMonitor(sgqlc.types.Interface):
    __schema__ = schema
    __field_names__ = ('uuid', 'monitor_type', 'created_time', 'last_update_time', 'creator_id', 'updater_id', 'resource_id', 'entities', 'entity_mcons', 'schedule_type', 'rule_name', 'description', 'notes', 'labels', 'notification_settings', 'is_snoozeable', 'is_paused', 'is_template_managed', 'namespace', 'next_execution_time', 'prev_execution_time', 'is_transitioning_data_provider', 'schedule_config')
    uuid = sgqlc.types.Field(sgqlc.types.non_null(UUID), graphql_name='uuid')
...
class Size(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('metric', 'ucs_upper', 'ucs_lower', 'ucs_min_size_change', 'ucs_reason', 'ucs_status', 'sd_upper', 'sd_lower', 'sd_reason', 'sd_status', 'last_size_change', 'detector_threshold')
    metric = sgqlc.types.Field(String, graphql_name='metric')
...
class TableCapabilitiesResponse(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('has_freshness', 'has_bytes', 'has_rows', 'has_volume_sli', 'has_write_throughput', 'has_query_logs', 'has_lineage', 'has_lineage_pipeline', 'has_field_lineage', 'has_objects_deleted', 'has_total_row_count_change', 'has_dynamic_schedule')
    ...
    has_lineage_pipeline = sgqlc.types.Field(Boolean, graphql_name='hasLineagePipeline')
    ...
    has_dynamic_schedule = sgqlc.types.Field(Boolean, graphql_name='hasDynamicSchedule')
...
class CustomRule(sgqlc.types.Type, Node):
    __schema__ = schema
    __field_names__ = ('uuid', 'rule_type', 'warehouse_uuid', 'comparisons', 'interval_minutes', 'interval_crontab', 'start_time', 'timezone', 'creator_id', 'updater_id', 'description', 'notes', 'prev_execution_time', 'next_execution_time', 'last_check_timestamp', 'created_time', 'updated_time', 'is_deleted', 'snooze_until_time', 'slack_snooze_user', 'dc_schedule_uuid', 'data_collection_dc_schedule_uuid', 'custom_sql', 'override', 'variables', 'generated_by', 'account_uuid', 'entities', 'projects', 'datasets', 'rule_name', 'namespace', 'is_template_managed', 'sequence_number', 'labels', 'system_snooze_until_time', 'query_result_type', 'custom_sampling_sql', 'generated_rules', 'entity_mcons', 'rendered_custom_sql', 'schedule_config', 'data_collection_schedule_config', 'notification_settings', 'is_snoozed')
    uuid = sgqlc.types.Field(sgqlc.types.non_null(UUID), graphql_name='uuid')
