...
class CCNetModel(NetModel):
    '''Class for a Chakraborti and Chakrabarti model on complex networks.
    Runs transactions in GPU using numba, multiple graphs can be used running in parallel.
    '''
    
    def __init__(self,G,wmin=1e-17):
        '''Create a new  Chakraborti and Chakrabarti model with the given graph or list of graphs 
