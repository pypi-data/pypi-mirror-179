...
#Kernels for the Monte Carlo Simulation Chakraborti and Chakrabarti
        ...
        if L2[i+1]-L2[i]==0: #check neighbors 
            ...
            for m in range(M):
                ...
                if wi>wmin and wj>wmin: #check if wealths are above the minimum
                    ...
                    #START Chakraborti and Chakrabarti exchange

                    #choosse winner
                    e=xoroshiro128p_uniform_float32(rng_states, i)

                    dw=e*Nr[j]*wj - (1-e)*Nr[i]*wi
                    ...
                    #END Chakraborti and Chakrabarti exchange
