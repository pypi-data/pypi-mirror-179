...
from .Kernels.kAi import gpu_MCS,gpu_MCSfollow,gpu_MCSepoch
from .Model import NetModel
from . Utils import ExceptionsManager as EM
import warnings


class AiNetModel(NetModel):
    '''Class for a All in trade model on complex networks.
    Runs transactions in GPU using numba, multiple graphs can be used running in parallel.
    '''
    
    def __init__(self,G,wmin=1e-17):
        '''Create a new All in trade model with the given graph or list of graphs and f value
