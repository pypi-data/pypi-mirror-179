...
T = TypeVar("T", bound="FlowModuleValue2Type3DefaultItemRetryExponential")


@attr.s(auto_attribs=True)
class FlowModuleValue2Type3DefaultItemRetryExponential:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_3_default_item_retry_exponential = cls(
            attempts=attempts,
            multiplier=multiplier,
            seconds=seconds,
        )

        flow_module_value_2_type_3_default_item_retry_exponential.additional_properties = d
        return flow_module_value_2_type_3_default_item_retry_exponential
