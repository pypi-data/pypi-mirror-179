...
from ..models.flow_module_value_2_type_3_branches_item import FlowModuleValue2Type3BranchesItem
from ..models.flow_module_value_2_type_3_default_item import FlowModuleValue2Type3DefaultItem
...
class FlowModuleValue2Type3:
    """
    Attributes:
        branches (List[FlowModuleValue2Type3BranchesItem]):
        default (List[FlowModuleValue2Type3DefaultItem]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for branches_item_data in _branches:
            branches_item = FlowModuleValue2Type3BranchesItem.from_dict(branches_item_data)
        ...
        for default_item_data in _default:
            default_item = FlowModuleValue2Type3DefaultItem.from_dict(default_item_data)
