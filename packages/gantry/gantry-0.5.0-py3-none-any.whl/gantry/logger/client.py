...
class Gantry:
    ...
    def log_records(  # noqa: C901
        ...
        Args:
            ...
            join_keys  (optional, List[str]): provide keys to identify each record.
                These keys can be used later to provide feedback. If not provided,
        ...
        Returns:
            A tuple of:
                ...
                (list[str]) join_keys: The record keys
