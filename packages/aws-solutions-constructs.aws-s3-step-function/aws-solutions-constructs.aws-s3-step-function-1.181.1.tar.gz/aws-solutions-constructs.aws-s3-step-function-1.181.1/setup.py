    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_s3_step_function._jsii": [
            "aws-s3-step-function@1.181.1.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_s3_step_function": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-stepfunctions-tasks==1.181.1",
        "aws-cdk.aws-stepfunctions==1.181.1",
        "aws-cdk.core==1.181.1",
        "aws-solutions-constructs.aws-events-rule-step-function==1.181.1",
        "aws-solutions-constructs.aws-s3-stepfunctions==1.181.1",
