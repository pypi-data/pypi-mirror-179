#!/usr/bin/env python3
from bugfinder.asrsummary import clear_asr_records
...
def save_record():
    from bugfinder.asrsummary import save_record
    save_record()


exported = ['dbinstall', 'syncfile', 'esyncfile', 'osssync', 'save_record', 'clear_asr_records']
