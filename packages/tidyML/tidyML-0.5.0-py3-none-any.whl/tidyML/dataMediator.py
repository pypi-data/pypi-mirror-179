...
class DataMediator:
    ...
    [Args]
        ...
        `externalIDs` (list[str]): List of sample IDs for external validation. \n
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.external = self.__splitDataFrame(externalIDs)
