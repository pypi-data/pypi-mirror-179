...
from pydantic import BaseModel, ModelMetaclass, Field
from pydantic.main import ModelMetaclass
from datetime import datetime


class DetaModelMetaclass(ModelMetaclass):
    def __new__(cls, clsname, bases, attrs, **kwargs):
        db_name = kwargs.pop('db_name', None)
        attrs['__base_name__'] = attrs.get('__base_name__', db_name)
        return super(DetaModelMetaclass, cls).__new__(cls, clsname, bases, attrs)
