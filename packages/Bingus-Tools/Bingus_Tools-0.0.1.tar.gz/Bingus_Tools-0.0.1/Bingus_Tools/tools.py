class Random:
    def random_number(start:int, end:int):
        import random
        print(f"Your random number is: {random.randint(start, end)}")
    ...
    def random_string(length:int):
        import random
        import string
        print(f"{''.join(random.choices(string.ascii_uppercase + string.ascii_lowercase + string.digits + string.punctuation, k=int(length)))}")
