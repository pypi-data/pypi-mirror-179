...
def transcription_entities(database_path: str) -> Optional[List[TranscriptionEntity]]:
    """
    Retrieve a transcription's entities
    """
    ...
    cursor.execute(
        """
        SELECT transcription_id, transcription.element_id, entity_id, entity.type, entity.name, entity.metas, offset, length FROM transcription_entity
