...
class AltoElement:
    def __init__(self, node):
        ...
        self.has_text = node.findall("alto:String", namespaces=self.namespaces)
    ...
    def parse_children(self):
        ...
        for child in self.content:
            child_element = AltoElement(child)
...
class RootAltoElement(AltoElement):
    def __init__(self, node):
        ...
        try:
            self.unit = node.find(
                "alto:Description/alto:MeasurementUnit", namespaces=self.namespaces
            ).text
        ...
        try:
            ...
            self.filename = node.find(
                "alto:Description/alto:sourceImageInformation/alto:fileName",
