# perllib module for pythonizer, generated by makelib.py on Sun Dec  4 09:54:14 2022
#
...
_PYTHONIZER_KEYWORDS = {'if','async','tuple','wantarray','globals','zip','ascii','await','hasattr','compile','isinstance','bool','re','enumerate','close','bin','as','str','print','is','chr','del','while','class','or','getattr','reversed','aiter','int','classmethod','callable','input','not','staticmethod','next','None','anext','lambda','issubclass','list','set','len','map','super','nonlocal','type','eval','ord','frozenset','iter','dir','except','divmod','with','break','help','import','False','locals','min','round','ArrayHash','bytearray','else','repr','exec','elif','for','from','global','pass','continue','sorted','any','float','return','setattr','filter','assert','dict','complex','id','memoryview','Array','delattr','raise','range','try','breakpoint','True','in','hex','property','object','sum','slice','finally','def','format','vars','perllib','pow','and','oct','Hash','all','hash','open','bytes','abs','yield','max'}
OS_ERROR = ''
LIST_SEPARATOR = ' '
INPUT_LAYERS = ''
