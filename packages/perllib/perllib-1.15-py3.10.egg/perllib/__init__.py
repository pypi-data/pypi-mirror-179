# perllib module for pythonizer, generated by makelib.py on Wed Nov 30 00:56:17 2022
#
...
INPUT_LAYERS = ''
CHILD_ERROR = 0
_PYTHONIZER_KEYWORDS = {'True','del','filter','anext','close','type','int','format','False','classmethod','iter','hasattr','ord','compile','if','as','range','id','delattr','ArrayHash','min','hex','all','str','break','is','finally','pass','oct','next','sum','setattr','Hash','staticmethod','map','and','complex','dir','not','nonlocal','from','def','help','issubclass','set','continue','Array','reversed','list','divmod','zip','with','bin','property','eval','getattr','isinstance','bytearray','global','locals','await','pow','enumerate','except','in','super','slice','any','input','open','assert','try','return','None','re','else','bool','round','raise','async','yield','exec','class','abs','breakpoint','ascii','wantarray','import','aiter','vars','frozenset','repr','print','globals','tuple','float','for','chr','lambda','sorted','memoryview','callable','dict','object','or','bytes','max','hash','len','while','elif','perllib'}
OUTPUT_AUTOFLUSH = 0
AUTODIE = 0
LIST_SEPARATOR = ' '
INPUT_LINE_NUMBER = 0
