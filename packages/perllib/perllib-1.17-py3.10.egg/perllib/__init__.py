# perllib module for pythonizer, generated by makelib.py on Mon Dec  5 00:30:19 2022
#
...
WARNING = 0
LIST_SEPARATOR = ' '
_PYTHONIZER_KEYWORDS = {'global','compile','help','zip','list','hash','round','isinstance','object','except','elif','filter','property','abs','is','return','set','del','break','tuple','not','with','ord','try','locals','staticmethod','ArrayHash','assert','from','chr','finally','super','bytearray','repr','True','open','breakpoint','in','lambda','next','def','len','globals','as','yield','bool','sorted','pass','dict','any','for','vars','hex','raise','hasattr','frozenset','getattr','map','eval','range','bytes','int','Hash','or','max','enumerate','exec','wantarray','False','type','callable','bin','anext','iter','min','re','while','memoryview','complex','await','class','oct','and','import','pow','dir','perllib','classmethod','nonlocal','sum','close','continue','id','Array','format','None','reversed','aiter','ascii','str','slice','else','if','setattr','input','delattr','all','float','divmod','async','print','issubclass'}
OUTPUT_LAYERS = ''
