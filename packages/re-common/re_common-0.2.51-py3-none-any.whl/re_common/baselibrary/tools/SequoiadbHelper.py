...
class SequoiadbUtils(object):
    ...
    def insert(self, record: dict):
        ...
        """
        return self.cl.insert(record)

    def replace_one(self, doc, **kwargs):
        """
        更新数据
        rule:  更新数据
        kwargs:
        ...
        """
        rule = {"$replace": doc}
        return self.cl.update(rule, **kwargs)

    def bulk_insert(self, flag: int, records: Union[list, tuple]):
        """
        插入多条数据
        :param flag:
        ...
        """
        return self.cl.bulk_insert(flag, records)
    ...
    def insert_with_flag(self, record, flag=INSERT_FLG_DEFAULT):
        ...
        :return:
        """
        return self.cl.insert_with_flag(record, flag)
    ...
    def delete(self, **kwargs):
        ...
        """
        return self.cl.delete(**kwargs)

    def update(self, rule: dict, **kwargs):
        """
        更新数据
        rule:  更新数据
        kwargs:
    ...
    def query(
        ...
        if hint is None:
            hint = {}
        return self.cl.query(condition=condition,
                             selector=selector,
                             order_by=order_by,
                             hint=hint,
    ...
    def query_and_update(self, update, **kwargs):
        ...
        :return: 返回查询的结果
        """
        return self.cl.query_and_update(update, **kwargs)
    ...
    def query_and_remove(self, **kwargs):
        ...
        :return: 返回查询的结果
        """
        return self.cl.query_and_remove(self, **kwargs)
    ...
    def create_lob(self, oid=None):
        ...
        :return:  一个objectid
        """
        return self.cl.create_lob(oid=oid)
    ...
    def create_lob_id(self, timestamp=None):
        ...
        """
        return self.cl.create_lob_id(timestamp=timestamp)
    ...
    def open_lob(self, oid, mode=LOB_READ):
        ...
        :return: a lob object
        """
        return self.cl.open_lob(oid, mode)
    ...
    def truncate_lob(self, oid, length):
        ...
        """
        self.cl.truncate_lob(oid, length)
    ...
    def list_lobs(self, **kwargs):
        ...
        """
        return self.cl.list_lobs(**kwargs)

    def lob_insert(self, record: str):
        """
        插入lob数据,输入字符串
        """
        try:
            lob_oid = self.cl.create_lob_id()
            lob_obj = self.cl.create_lob(lob_oid)
    ...
    def replace_lob(self, record: str, lob_oid: str):
        """
        插入lob数据,输入字符串
        """
        try:
            lob_obj = self.cl.open_lob(lob_oid, mode=LOB_WRITE)
            lob_obj.write(record, len(record))
            lob_obj.close()
            return str(lob_oid)
        except Exception as e:
    ...
    def lob_query(self, oid):
        """
        查询lob数据
        """
        lob_file = self.cl.open_lob(oid)
