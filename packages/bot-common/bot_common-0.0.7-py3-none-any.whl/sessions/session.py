from src.utils.utils import catch_exception, get_time_now, clean_string
from src.utils.db_utils import DbConfig, create_table_if_not_exists, db_connect, update_table
from src.sessions.session_model import SessionObject, session_headers as headers
...
class SessionGet:
    ...
    def existing_all(self) -> List[Session]:
        get_existing_sessions_query = f"SELECT * FROM {tab_name};"
