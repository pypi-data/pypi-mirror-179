    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_dynamodbstreams_lambda_elasticsearch_kibana._jsii": [
            "aws-dynamodbstreams-lambda-elasticsearch-kibana@1.181.1.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_dynamodbstreams_lambda_elasticsearch_kibana": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-event-sources==1.181.1",
        "aws-cdk.aws-lambda==1.181.1",
        "aws-cdk.aws-sqs==1.181.1",
        "aws-cdk.core==1.181.1",
        "aws-solutions-constructs.aws-dynamodbstreams-lambda==1.181.1",
        "aws-solutions-constructs.aws-lambda-elasticsearch-kibana==1.181.1",
