...
from wenxin_api.variable import REQUEST_SLEEP_TIME, VILG_CREATE_URL, VILG_RETRIEVE_URL, \
                                VILG_CREATE_URL_CONSOLE, VILG_RETRIEVE_URL_CONSOLE
...
class TextToImage(Task):
    ...
    def _http_init(self):
        ...
        self.create_url = VILG_CREATE_URL
        self.retrieve_url = VILG_RETRIEVE_URL
...
class TextToImageConsole(TextToImage):
    ...
    def _http_init(self):
        ...
        self.create_url = VILG_CREATE_URL_CONSOLE + "?access_token={}".format(access_token)
        self.retrieve_url = VILG_RETRIEVE_URL_CONSOLE + "?access_token={}".format(access_token)
