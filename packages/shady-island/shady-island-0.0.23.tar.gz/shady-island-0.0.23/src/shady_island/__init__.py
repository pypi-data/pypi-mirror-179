...
@jsii.data_type(
    ...
    jsii_struct_bases=[aws_cdk.aws_efs.FileSystemProps],
    name_mapping={
        "vpc": "vpc",
...
class EncryptedFileSystemProps(aws_cdk.aws_efs.FileSystemProps):
    def __init__(
        self,
        *,
        vpc: aws_cdk.aws_ec2.IVpc,
        ...
        lifecycle_policy: typing.Optional[aws_cdk.aws_efs.LifecyclePolicy] = None,
        out_of_infrequent_access_policy: typing.Optional[aws_cdk.aws_efs.OutOfInfrequentAccessPolicy] = None,
        performance_mode: typing.Optional[aws_cdk.aws_efs.PerformanceMode] = None,
        provisioned_throughput_per_second: typing.Optional[aws_cdk.Size] = None,
        ...
        throughput_mode: typing.Optional[aws_cdk.aws_efs.ThroughputMode] = None,
        vpc_subnets: typing.Optional[typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
    ...
    @builtins.property
    def lifecycle_policy(self) -> typing.Optional[aws_cdk.aws_efs.LifecyclePolicy]:
        '''A policy used by EFS lifecycle management to transition files to the Infrequent Access (IA) storage class.

        :default: - None. EFS will not transition files to the IA storage class.
        '''
        result = self._values.get("lifecycle_policy")
        return typing.cast(typing.Optional[aws_cdk.aws_efs.LifecyclePolicy], result)

    @builtins.property
    def out_of_infrequent_access_policy(
        self,
    ) -> typing.Optional[aws_cdk.aws_efs.OutOfInfrequentAccessPolicy]:
        ...
        return typing.cast(typing.Optional[aws_cdk.aws_efs.OutOfInfrequentAccessPolicy], result)

    @builtins.property
    def performance_mode(self) -> typing.Optional[aws_cdk.aws_efs.PerformanceMode]:
    ...
    @builtins.property
    def provisioned_throughput_per_second(self) -> typing.Optional[aws_cdk.Size]:
    ...
    @builtins.property
    def throughput_mode(self) -> typing.Optional[aws_cdk.aws_efs.ThroughputMode]:
        '''Enum to mention the throughput mode of the file system.

        :default: ThroughputMode.BURSTING
        '''
        result = self._values.get("throughput_mode")
        return typing.cast(typing.Optional[aws_cdk.aws_efs.ThroughputMode], result)
...
class IEncryptedFileSystem(constructs.IConstruct, typing_extensions.Protocol):
...
class UserDataBuilder(
    ...
    def for_linux(
        ...
        *,
        ...
        '''
        options = aws_cdk.aws_ec2.LinuxUserDataOptions(shebang=shebang)
    ...
    @abc.abstractmethod
    def build_user_data(self) -> aws_cdk.aws_ec2.UserData:
    ...
    def insert_commands(self, priority: jsii.Number, *commands: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(priority: jsii.Number, *commands: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument priority", value=priority, expected_type=type_hints["priority"])
            check_type(argname="argument commands", value=commands, expected_type=typing.Tuple[type_hints["commands"], ...]) # pyright: ignore [reportGeneralTypeIssues]
...
class _UserDataBuilderProxy(UserDataBuilder):
    ...
    def build_user_data(self) -> aws_cdk.aws_ec2.UserData:
        ...
        :return: The assembled User Data
        '''
        return typing.cast(aws_cdk.aws_ec2.UserData, jsii.invoke(self, "buildUserData", []))
